...
class sam$kotlinx_coroutines_flow_FlowCollector$0 {
  ...
  *g19(value, $completion) {
    return yield* this.n5d_1(value, $completion);
  }
  l4() {
    return this.n5d_1;
  }
...
class KotlinxSerializationConverter$serialize$$inlined$map$1 {
  constructor($this, $contentType, $charset, $typeInfo, $value) {
    this.o5d_1 = $this;
    this.p5d_1 = $contentType;
    this.q5d_1 = $charset;
    this.r5d_1 = $typeInfo;
    this.s5d_1 = $value;
  }
  *f19(collector, $completion) {
    var tmp = KotlinxSerializationConverter$serialize$o$collect$slambda(collector, this.p5d_1, this.q5d_1, this.r5d_1, this.s5d_1);
    yield* this.o5d_1.d19(new sam$kotlinx_coroutines_flow_FlowCollector$0(tmp), $completion);
...
class KotlinxSerializationConverter {
  constructor(format) {
    this.t5d_1 = format;
    this.u5d_1 = extensions(this.t5d_1);
    var tmp;
    var tmp_0 = this.t5d_1;
    if (isInterface(tmp_0, BinaryFormat)) {
      tmp = true;
    } else {
      var tmp_1 = this.t5d_1;
      tmp = isInterface(tmp_1, StringFormat);
    }
    // Inline function 'kotlin.require' call
    if (!tmp) {
      var message = 'Only binary and string formats are supported, ' + toString(this.t5d_1) + ' is not supported.';
      throw IllegalArgumentException.c2(toString(message));
    }
  }
  *v5d(contentType, charset, typeInfo, value, $completion) {
    // Inline function 'kotlinx.coroutines.flow.map' call
    // Inline function 'kotlinx.coroutines.flow.unsafeTransform' call
    var this_0 = asFlow(this.u5d_1);
    ...
    var tmp_0;
    try {
      tmp_0 = serializerForTypeInfo(this.t5d_1.x1c(), typeInfo);
    } catch ($p) {
      var tmp_1;
      if ($p instanceof SerializationException) {
        var cause = $p;
        tmp_1 = guessSerializer(value, this.t5d_1.x1c());
      } else {
        throw $p;
      }
      tmp_0 = tmp_1;
    ...
    return serializeContent(this, serializer, this.t5d_1, value, contentType, charset);
  }
  l5d(contentType, charset, typeInfo, value, $completion) {
    return this.v5d(contentType, charset, typeInfo, value, $completion);
  }
  *d3d(charset, typeInfo, content, $completion) {
    var contentPacket = yield* readRemaining(content, $completion);
    var _iterator__ex2g4s = this.u5d_1.l1();
    $l$loop: while (_iterator__ex2g4s.m1()) {
      var ext = _iterator__ex2g4s.n1();
      var tmp0_elvis_lhs = yield* ext.d3d(charset, typeInfo, ByteReadChannel(contentPacket), $completion);
      var tmp;
    ...
    var serializer = serializerForTypeInfo(this.t5d_1.x1c(), typeInfo);
    try {
      var tmp1_subject = this.t5d_1;
      var tmp_0;
      if (isInterface(tmp1_subject, StringFormat)) {
        tmp_0 = this.t5d_1.k1d(serializer, readText(contentPacket, charset));
      } else {
        if (isInterface(tmp1_subject, BinaryFormat)) {
          tmp_0 = this.t5d_1.m1d(serializer, readByteArray(contentPacket));
        } else {
          discard(contentPacket);
          // Inline function 'kotlin.error' call
          var message = 'Unsupported format ' + toString(this.t5d_1);
      ...
      if ($p instanceof Error) {
        var cause = $p;
        throw JsonConvertException.w3c('Illegal input: ' + cause.message, cause);
      } else {
        throw $p;
      }
    }
...
function extensions(format) {
  ...
  while (_iterator__ex2g4s.m1()) {
    ...
    var tmp0_safe_receiver = element.m5d(format);
...
function serialization(_this__u8e3s4, contentType, format) {
  _this__u8e3s4.b3d(contentType, new KotlinxSerializationConverter(format));
}
function KotlinxSerializationConverter$serialize$o$collect$slambda($$this$unsafeFlow, $contentType, $charset, $typeInfo, $value) {
  return constructCallableReference(function *(value, $completion) {
    ...
    var tmp$ret$1 = yield* value.l5d($contentType, $charset, $typeInfo, $value, $completion);
...
function serializerForTypeInfo(_this__u8e3s4, typeInfo) {
  ...
  if (tmp1_elvis_lhs == null) {
    var tmp2_safe_receiver = module_0.m1e(typeInfo.z2o_1);
    tmp_1 = tmp2_safe_receiver == null ? null : maybeNullable(tmp2_safe_receiver, typeInfo);
  } else {
    tmp_1 = tmp1_elvis_lhs;
  }
  var tmp3_elvis_lhs = tmp_1;
  return tmp3_elvis_lhs == null ? maybeNullable(serializer(typeInfo.z2o_1), typeInfo) : tmp3_elvis_lhs;
}
...
function checkTypeParameters(type, typeInfo, module_0) {
  ...
  throw SerializationException.x1d('Serializer for type argument' + s + ' ' + argNames + ' ' + be + " not found for '" + typeInfo.z2o_1.f1() + "'. " + ('Ensure that the listed type' + s + ' ' + be + " marked as '@Serializable'."));
}

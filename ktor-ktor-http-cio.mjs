...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.x35_1 = 0;
    this.y35_1 = 0;
    this.z35_1 = get_HeadersDataPool().e2i();
  }
  b21(name) {
    if (this.x35_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.y35_1 | 0;
    while (!(this.z35_1.e36(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.g36(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.y35_1 | 0;
    }
    return null;
  }
  h36() {
    return this.z35_1.d36();
  }
  f36(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.w35_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.w35_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.y35_1 | 0;
    ...
    this.z35_1.p36(headerOffset + 0 | 0, hash);
    this.z35_1.p36(headerOffset + 1 | 0, nameStartIndex);
    this.z35_1.p36(headerOffset + 2 | 0, nameEndIndex);
    this.z35_1.p36(headerOffset + 3 | 0, valueStartIndex);
    this.z35_1.p36(headerOffset + 4 | 0, valueEndIndex);
    this.z35_1.p36(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.z35_1.p36(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.x35_1 = this.x35_1 + 1 | 0;
  }
  q36(headerOffset) {
    var nameStartIndex = this.z35_1.e36(headerOffset + 1 | 0);
    var nameEndIndex = this.z35_1.e36(headerOffset + 2 | 0);
    return this.w35_1.c(nameStartIndex, nameEndIndex);
  }
  g36(headerOffset) {
    var valueStartIndex = this.z35_1.e36(headerOffset + 3 | 0);
    var valueEndIndex = this.z35_1.e36(headerOffset + 4 | 0);
    return this.w35_1.c(valueStartIndex, valueEndIndex);
  }
  l1y() {
    this.x35_1 = 0;
    this.y35_1 = 0;
    get_HeadersDataPool().f2i(this.z35_1);
    this.z35_1 = get_HeadersDataPool().e2i();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.a36_1 = ArrayList.p2();
  }
  b36() {
    return this.a36_1.g2();
  }
  c36(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.a36_1.d2(get_IntArrayPool().e2i());
      }
       while (inductionVariable < subArraysCount);
  }
  e36(index) {
    return this.a36_1.f2(index / 768 | 0)[index % 768 | 0];
  }
  p36(index, value) {
    this.a36_1.f2(index / 768 | 0)[index % 768 | 0] = value;
  }
  d36() {
    return sequence(HeadersData$headersStarts$slambda(this));
  }
  l1y() {
    var _iterator__ex2g4s = this.a36_1.l1();
...
class IntArrayPool$1 extends DefaultPool {
  ...
  c2i(instance) {
    return this.u36(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  c2i(instance) {
    return this.y36(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  constructor(message) {
    return new.target.f37(message);
  }
  static f37(message) {
    var $this = this.o(message);
    captureStack($this, $this.e37_1);
    return $this;
  }
}
...
class Companion {
  g37(from) {
    ...
    return this.t37(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  t37(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
...
class SubSequenceImpl {
  ...
  a() {
    return this.w37_1 - this.v37_1 | 0;
  }
  b(index) {
    var withOffset = index + this.v37_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.w37_1 - this.v37_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.c2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.y37_1, this.v37_1 + startIndex | 0, this.v37_1 + endIndex | 0);
  }
  toString() {
    var tmp0_elvis_lhs = this.x37_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.y37_1, this.v37_1, this.w37_1));
      this.x37_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.y37_1, this.v37_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.x37_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.y37_1, this.v37_1, this.w37_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.o36_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.o36_1 + ')';
      throw IllegalArgumentException.c2(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.o36_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.o36_1 + ')';
      throw IllegalArgumentException.c2(toString(message_1));
    }
  ...
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.o36_1));
      this.l36_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.o36_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.o36_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.l36_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.o36_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.k36_1).length - this.n36_1 | 0] = value;
    this.l36_1 = null;
    this.n36_1 = this.n36_1 - 1 | 0;
    this.o36_1 = this.o36_1 + 1 | 0;
    return this;
  }
  zf(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.n36_1 | 0;
      ...
      this.n36_1 = this.n36_1 - bytesToCopy | 0;
    }
    this.l36_1 = null;
    this.o36_1 = this.o36_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  e2(value) {
    if (value == null)
  ...
  l1y() {
    ...
    if (!(list == null)) {
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.i36_1.f2i(tmp0_safe_receiver);
      }
      this.k36_1 = null;
    }
    this.m36_1 = true;
...
class UnsupportedMediaTypeExceptionCIO extends IOException {
  constructor(message) {
    return new.target.o37(message);
  }
  static o37(message) {
    var $this = this.u2d(message);
    captureStack($this, $this.n37_1);
    return $this;
  }
}
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.z36_1 + ', end=' + this.a37_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.x35_1 >= $this.y35_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.x35_1;
  var prevData = $this.z35_1;
  $this.x35_1 = 0;
  $this.y35_1 = imul($this.y35_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().e2i();
  this_0.c36(imul(prevData.b36(), 2) | 1);
  tmp.z35_1 = this_0;
  var _iterator__ex2g4s = prevData.d36().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.f36(prevData.e36(headerOffset + 1 | 0), prevData.e36(headerOffset + 2 | 0), prevData.e36(headerOffset + 3 | 0), prevData.e36(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().f2i(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.x35_1)) {
...
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.h36().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.e2(indent);
    out.e2(_this__u8e3s4.q36(offset));
    out.e2(' => ');
    out.e2(_this__u8e3s4.g36(offset));
    out.e2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.a37_1 = builder.o36_1;
      var rangeLength = range.a37_1 - range.z36_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.z36_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.a37_1;
      parseHeaderValue(builder, range);
      var valueStart = range.z36_1;
      var valueEnd = range.a37_1;
      range.z36_1 = headerEnd;
      headers.f36(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.b21('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.z36_1;
  var end = range.a37_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.z36_1)) {
      range.z36_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.z36_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.z36_1 = valueStart;
  range.a37_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.f37("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
  ...
  if (tmp$ret$0) {
    throw ParserException.f37('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.f37('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.f37('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.z36_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.a37_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.f37('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.f37('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    versions = Companion_instance.g37(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().p2r(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.o37('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.b21('Content-Length');
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.k36_1).length | 0];
}
...
function bufferForIndex($this, index) {
  ...
  return list.f2(index / ensureNotNull($this.k36_1).length | 0);
}
...
function nonFullBuffer($this) {
  return $this.n36_1 === 0 ? appendNewArray($this) : ensureNotNull($this.k36_1);
}
function appendNewArray($this) {
  var newBuffer = $this.i36_1.e2i();
  var existing = $this.k36_1;
  $this.k36_1 = newBuffer;
  $this.n36_1 = newBuffer.length;
  $this.m36_1 = false;
  if (!(existing == null)) {
...
function currentPosition($this) {
  return ensureNotNull($this.k36_1).length - $this.n36_1 | 0;
}
...
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.u2y_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.u2y_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().t2y_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.t37(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);

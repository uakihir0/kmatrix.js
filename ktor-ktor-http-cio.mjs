...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.j36_1 = 0;
    this.k36_1 = 0;
    this.l36_1 = get_HeadersDataPool().n2i();
  }
  a21(name) {
    if (this.j36_1 === 0)
      return null;
  ...
  r36(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
  ...
  k1y() {
    this.j36_1 = 0;
    this.k36_1 = 0;
    get_HeadersDataPool().o2i(this.l36_1);
    this.l36_1 = get_HeadersDataPool().n2i();
  }
  toString() {
...
class HeadersData$headersStarts$slambda {
  ...
  *e37($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this.d37_1.m36_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this.d37_1.q36(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.yi(joinedIndex, $completion);
        }
  ...
  wc(p1, $completion) {
    return this.e37(p1 instanceof SequenceScope ? p1 : THROW_CCE(), $completion);
  }
}
class HeadersData {
  constructor() {
    ...
    tmp.m36_1 = ArrayList.p2();
  }
  n36() {
    return this.m36_1.g2();
  }
  o36(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.m36_1.d2(get_IntArrayPool().n2i());
      }
       while (inductionVariable < subArraysCount);
  }
  q36(index) {
    return this.m36_1.f2(index / 768 | 0)[index % 768 | 0];
  }
  b37(index, value) {
    this.m36_1.f2(index / 768 | 0)[index % 768 | 0] = value;
  }
  p36() {
    return sequence(HeadersData$headersStarts$slambda_0(this));
  }
  k1y() {
    var _iterator__ex2g4s = this.m36_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().o2i(array);
    }
    this.m36_1.c4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  i37(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).l2i.call(this, instance);
  }
  l2i(instance) {
    return this.i37(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  l2i(instance) {
    return this.m37(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
...
class parseMultipart$slambda$slambda {
  constructor($firstBoundary, $countedInput) {
    this.d38_1 = $firstBoundary;
    this.e38_1 = $countedInput;
  }
  *f38($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl(this.d38_1, this.e38_1, $this$writer.y2g_1, 8193n, $completion);
    yield* $this$writer.y2g_1.b2g($completion);
    return Unit_instance;
  }
  wc(p1, $completion) {
...
class parseMultipart$slambda {
  constructor($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
    this.g38_1 = $input;
    this.h38_1 = $boundaryPrefixed;
    this.i38_1 = $maxPartSize;
    this.j38_1 = $totalLength;
  }
  *k38($this$produce, $completion) {
    var countedInput = counted(this.g38_1);
    var readBeforeParse = countedInput.l2h();
    var firstBoundary = this.h38_1.j2a(get_PrefixString().g2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda_0(firstBoundary, countedInput)).o2g_1, $completion);
    if (get_remaining(preambleData) > 0n) {
      yield* $this$produce.g17(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.r2f() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
      ...
      yield* $this$produce.g17(part, $completion);
      var headersMap = null;
      try {
        headersMap = yield* /*#__NOINLINE__*/parsePartHeadersImpl(countedInput, $completion);
        if (!headers.uy(headersMap)) {
          headersMap.k1y();
          throw CancellationException.n('Multipart processing has been cancelled');
        }
        yield* /*#__NOINLINE__*/parsePartBodyImpl(this.h38_1, countedInput, body, headersMap, this.i38_1, $completion);
        body.a6();
      } catch ($p) {
    ...
    yield* skipIfFound(countedInput, get_CrLf(), $completion);
    if (!(this.j38_1 == null)) {
      var consumedExceptEpilogue = subtract(countedInput.l2h(), readBeforeParse);
      var size = subtract(this.j38_1, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.y2d('Failed to parse multipart: prologue is too long');
      if (size > 0n) {
        yield* $this$produce.g17(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      if (!epilogueContent.v2a()) {
        yield* $this$produce.g17(new Epilogue(epilogueContent), $completion);
      }
    }
    return Unit_instance;
  }
  wc(p1, $completion) {
    return this.k38((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  }
}
class Node {
...
class Companion {
  u37(from) {
    ...
    return this.p38(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  p38(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
...
class SubSequenceImpl {
  ...
  a() {
    return this.s38_1 - this.r38_1 | 0;
  }
  b(index) {
    var withOffset = index + this.r38_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.s38_1 - this.r38_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.c2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.u38_1, this.r38_1 + startIndex | 0, this.r38_1 + endIndex | 0);
  }
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = toString(copy(this.u38_1, this.r38_1, this.s38_1));
      this.t38_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.u38_1, this.r38_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.t38_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.u38_1, this.r38_1, this.s38_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  e2(value) {
    if (value == null)
      return this;
    return this.yf(value, 0, charSequenceLength(value));
  }
  k1y() {
    var list = this.v36_1;
    if (!(list == null)) {
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.u36_1.o2i(tmp0_safe_receiver);
      }
      this.w36_1 = null;
    }
    this.y36_1 = true;
...
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.n37_1 + ', end=' + this.o37_1 + ')';
  }
}
//endregion
...
function resize($this) {
  ...
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().n2i();
  this_0.o36(imul(prevData.n36(), 2) | 1);
  tmp.l36_1 = this_0;
  var _iterator__ex2g4s = prevData.p36().l1();
  while (_iterator__ex2g4s.m1()) {
  ...
  get_HeadersDataPool().o2i(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
...
function HeadersData$headersStarts$slambda_0(this$0) {
  ...
  var l = ($this$sequence, $completion) => i.e37($this$sequence, $completion);
  l.$arity = 1;
  return l;
}
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.t36().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.e2(indent);
    out.e2(_this__u8e3s4.c37(offset));
    out.e2(' => ');
    out.e2(_this__u8e3s4.s36(offset));
    out.e2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.o37_1 = builder.a37_1;
      var rangeLength = range.o37_1 - range.n37_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.n37_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.o37_1;
      parseHeaderValue(builder, range);
      var valueStart = range.n37_1;
      var valueEnd = range.o37_1;
      range.n37_1 = headerEnd;
      headers.r36(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.a21('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.n37_1;
  var end = range.o37_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.n37_1)) {
      range.n37_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.n37_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.n37_1 = valueStart;
  range.o37_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.t37("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
  ...
  if (tmp$ret$0) {
    throw ParserException.t37('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.t37('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.t37('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.n37_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.o37_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.t37('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.t37('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().o2h_1, Companion_getInstance_0().n2h_1);
    versions = Companion_instance.u37(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().b2s(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.c38('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.i2a(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.y2d("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.y2d('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.y2d('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.t2a('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.a21('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.y2d('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.y2d("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda_0($firstBoundary, $countedInput) {
  ...
  var l = ($this$writer, $completion) => i.f38($this$writer, $completion);
  l.$arity = 1;
  return l;
}
function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  ...
  var l = ($this$produce, $completion) => i.k38($this$produce, $completion);
  l.$arity = 1;
  return l;
}
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.i2a(toByteArray_0('\r\n'));
...
function bufferForIndex($this, index) {
  ...
  return list.f2(index / ensureNotNull($this.w36_1).length | 0);
}
...
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.g2z_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.g2z_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().f2z_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.p38(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);

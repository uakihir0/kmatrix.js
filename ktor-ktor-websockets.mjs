...
class Companion {
  constructor() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = element.c38_1;
      destination.z3(tmp$ret$2, element);
    }
    tmp.d38_1 = destination;
    this.e38_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  f38(code) {
    return this.d38_1.w3(code);
  }
}
...
class CloseReason {
  constructor(code, message) {
    return new.target.i38(code, message);
  }
  static i38(code, message) {
    var $this = createThis(this);
    $this.g38_1 = code;
    $this.h38_1 = message;
    return $this;
  }
  static j38(code, message) {
    return this.i38(code.c38_1, message);
  }
  k38() {
    return Companion_getInstance().f38(this.g38_1);
  }
  toString() {
    var tmp0_elvis_lhs = this.k38();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.g38_1 : tmp0_elvis_lhs) + ', message=' + this.h38_1 + ')';
  }
  hashCode() {
    var result = this.g38_1;
    result = imul(result, 31) + getStringHashCode(this.h38_1) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
...
function *send(frame, $completion) {
  yield* this.p38().h17(frame, $completion);
...
class Companion_0 {
  constructor() {
    ...
    this.p39_1 = Pong.l3a(new Int8Array(0), NonDisposableHandle_instance);
  }
}
class DefaultWebSocketSessionImpl {
  constructor(raw, pingIntervalMillis, timeoutMillis, incomingFramesConfig, outgoingFramesConfig) {
    ...
    this.u38_1 = raw;
    this.v38_1 = atomic$ref$1(null);
    this.w38_1 = CompletableDeferred();
    this.x38_1 = Job();
    this.y38_1 = this.u38_1.ss().mj(Key_instance).oj(this.x38_1).oj(new CoroutineName('ws-default'));
    this.z38_1 = from(Factory_getInstance(), incomingFramesConfig);
    this.a39_1 = from(Factory_getInstance(), outgoingFramesConfig);
    this.b39_1 = atomic$boolean$1(false);
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.c39_1 = ArrayList.p2();
    this.d39_1 = atomic$boolean$1(false);
    this.e39_1 = pingIntervalMillis;
    this.f39_1 = timeoutMillis;
    this.g39_1 = this.w38_1;
  }
  ss() {
    return this.y38_1;
  }
  ...
  m38(value) {
    this.u38_1.m38(value);
  }
  n38() {
    return this.u38_1.n38();
  }
  l38(negotiatedExtensions) {
    if (!this.d39_1.atomicfu$compareAndSet(false, true)) {
    ...
    if (get_isTraceEnabled(this_0)) {
      ...
      this_0.l2p(tmp$ret$2);
    }
    this.c39_1.o2(negotiatedExtensions);
    runOrCancelPinger(this);
    var incomingJob = runIncomingProcessor(this, ponger(this, this.p38()));
  ...
  *v2f($completion) {
    yield* this.u38_1.v2f($completion);
    return Unit_instance;
  }
}
...
class FrameTooBigException extends Exception {
  constructor(frameSize, cause) {
    return new.target.a3a(frameSize, cause);
  }
  static a3a(frameSize, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.jd(cause);
    captureStack($this, $this.z39_1);
    $this.y39_1 = frameSize;
    delete $this.message;
    return $this;
  }
  r() {
    var sizeSuffix = this.y39_1 >= 0n ? ': ' + this.y39_1.toString() : '';
    return 'Frame is too big' + sizeSuffix;
  }
  iz() {
    return FrameTooBigException.a3a(this.y39_1, this);
  }
  get message() {
    return this.r();
  }
...
class Companion_1 {
  constructor() {
    ...
    tmp.s3a_1 = ensureNotNull(tmp$ret$0).r3a_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.s3a_1 + 1 | 0;
...
class Companion_2 {
  constructor() {
    ...
    this_0.s38_1 = this_0.c3b();
    this_0.t38_1 = this_0.c3b();
    tmp.r38_1 = this_0;
  }
}
class WebSocketChannelsConfig {
  constructor() {
    ...
    this.s38_1 = Companion_getInstance_3().d3b_1;
    this.t38_1 = Companion_getInstance_3().d3b_1;
  }
  c3b() {
    return Companion_getInstance_3().d3b_1;
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.d3b_1 = new ChannelConfig(2147483647, ChannelOverflow_SUSPEND_getInstance());
  }
}
class ChannelConfig {
  constructor(capacity, onOverflow) {
    ...
    this.e3b_1 = capacity;
    this.f3b_1 = onOverflow;
  }
  g3b() {
    return this.f3b_1.equals(ChannelOverflow_SUSPEND_getInstance()) && !(this.e3b_1 === 2147483647);
  }
}
...
class BoundedChannel {
  constructor(capacity, delegate) {
    delegate = delegate === VOID ? Companion_instance_4.l3b(capacity) : delegate;
    this.m3b_1 = delegate;
  }
  n3b(element) {
    var result = this.m3b_1.i17(element);
    if (!_ChannelResult___get_isSuccess__impl__odq1z9(result) && !_ChannelResult___get_isClosed__impl__mg7kuu(result)) {
      this.r17(ChannelOverflowException.k3b('Channel overflowed'));
    }
    return result;
  }
  i17(element) {
    return this.n3b(element);
  }
  *o3b(element, $completion) {
    yield* this.m3b_1.h17(element, $completion);
    return Unit_instance;
  }
  h17(element, $completion) {
    return this.o3b(element, $completion);
  }
  r17(cause) {
    return this.m3b_1.r17(cause);
  }
  a17() {
    return this.m3b_1.a17();
  }
  *p3b($completion) {
    return yield* this.m3b_1.k17($completion);
  }
  k17($completion) {
    return this.p3b($completion);
  }
  l1() {
    return this.m3b_1.l1();
  }
  cu(cause) {
    this.m3b_1.cu(cause);
  }
...
class ChannelOverflowException extends RuntimeException {
  constructor(message) {
    return new.target.k3b(message);
  }
  static k3b(message) {
    var $this = this.ga(message);
    captureStack($this, $this.j3b_1);
    return $this;
  }
}
...
class WebSocketExtensionsConfig {
  constructor() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.s3b_1 = ArrayList.p2();
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp_0.t3b_1 = [false, false, false];
  }
  k2t() {
...
class WebSocketExtensionHeader {
  constructor(name, parameters) {
    this.u3b_1 = name;
    this.v3b_1 = parameters;
  }
  toString() {
    return this.u3b_1 + ' ' + parametersToString(this);
  }
}
class Frame {
  static e3c(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    var $this = createThis(this);
    $this.q39_1 = fin;
    $this.r39_1 = frameType;
    $this.s39_1 = data;
    $this.t39_1 = disposableHandle;
    $this.u39_1 = rsv1;
    $this.v39_1 = rsv2;
    $this.w39_1 = rsv3;
    return $this;
  ...
  toString() {
    return 'Frame ' + this.r39_1.toString() + ' (fin=' + this.q39_1 + ', buffer len = ' + this.s39_1.length + ')';
  }
}
class Binary extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.d3c(fin, data, rsv1, rsv2, rsv3);
  }
  static d3c(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.e3c(fin, FrameType_BINARY_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static f3c(fin, data) {
    return this.d3c(fin, data, false, false, false);
  }
}
class Text extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.n3c(fin, data, rsv1, rsv2, rsv3);
  }
  static n3c(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.e3c(fin, FrameType_TEXT_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static o3c(fin, data) {
    return this.n3c(fin, data, false, false, false);
  }
  static p3c(text) {
    return this.o3c(true, toByteArray(text));
  }
}
class Close extends Frame {
  constructor(data) {
    return new.target.q3c(data);
  }
  static q3c(data) {
    return this.e3c(true, FrameType_CLOSE_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
  static o39(reason) {
    // Inline function 'io.ktor.utils.io.core.buildPacket' call
    var builder = new Buffer();
    builder.m2c(reason.g38_1);
    writeText(builder, reason.h38_1);
    return this.r3c(builder);
  }
  static r3c(packet) {
    return this.q3c(readByteArray(packet));
  }
  static s3c() {
    return this.q3c(Companion_getInstance_5().m3a_1);
  }
}
class Ping extends Frame {
  constructor(data) {
    return new.target.b3b(data);
  }
  static b3b(data) {
    return this.e3c(true, FrameType_PING_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
}
class Pong extends Frame {
  constructor(data, disposableHandle) {
    return new.target.l3a(data, disposableHandle);
  }
  static l3a(data, disposableHandle) {
    disposableHandle = disposableHandle === VOID ? NonDisposableHandle_instance : disposableHandle;
    return this.e3c(true, FrameType_PONG_getInstance(), data, disposableHandle, false, false, false);
  }
}
class Companion_5 {
  constructor() {
    Companion_instance_5 = this;
    this.m3a_1 = new Int8Array(0);
  }
  n3a(fin, frameType, data, rsv1, rsv2, rsv3) {
    var tmp;
    switch (frameType.s1_1) {
      case 1:
        tmp = Binary.d3c(fin, data, rsv1, rsv2, rsv3);
        break;
      case 0:
        tmp = Text.n3c(fin, data, rsv1, rsv2, rsv3);
        break;
      case 2:
        tmp = Close.q3c(data);
        break;
      case 3:
        ...
        break;
      case 4:
        tmp = Pong.l3a(data, NonDisposableHandle_instance);
        break;
      default:
...
function DefaultWebSocketSession_0(session, pingIntervalMillis, timeoutMillis, channelsConfig) {
  ...
  channelsConfig = channelsConfig === VOID ? Companion_getInstance_2().r38_1 : channelsConfig;
  _init_properties_DefaultWebSocketSession_kt__469s0y();
  ...
  return new DefaultWebSocketSessionImpl(session, pingIntervalMillis, timeoutMillis, channelsConfig.s38_1, channelsConfig.t38_1);
}
function runIncomingProcessor($this, ponger) {
  var tmp = get_IncomingProcessorCoroutineName().oj(Dispatchers_getInstance().h13_1);
...
function runOutgoingProcessor($this) {
  var tmp = get_OutgoingProcessorCoroutineName().oj(Dispatchers_getInstance().h13_1);
...
function *outgoingProcessorLoop($this, $completion) {
  var _iterator__ex2g4s = $this.a39_1.l1();
  $l$loop: while (yield* _iterator__ex2g4s.t16($completion)) {
    var frame = _iterator__ex2g4s.n1();
    // Inline function 'io.ktor.util.logging.trace' call
    var this_0 = get_LOGGER();
    if (get_isTraceEnabled(this_0)) {
      var tmp$ret$1 = 'Sending ' + frame.toString() + ' from session ' + toString($this);
      this_0.l2p(tmp$ret$1);
    }
    var tmp;
    ...
    yield* $this.u38_1.p38().h17(processedFrame, $completion);
  }
  return Unit_instance;
}
function *sendCloseSequence($this, reason, exception, $completion) {
  ...
  $this.x38_1.xy();
  var reasonToSend = reason == null ? CloseReason.j38(Codes_NORMAL_getInstance(), '') : reason;
  try {
    runOrCancelPinger($this);
    if (!(reasonToSend.g38_1 === Codes_CLOSED_ABNORMALLY_getInstance().c38_1)) {
      yield* $this.u38_1.p38().h17(Close.o39(reasonToSend), $completion);
    }
  }finally {
    $this.w38_1.vy(reasonToSend);
    if (!(exception == null)) {
      $this.a39_1.r17(exception);
      $this.z38_1.r17(exception);
    }
  }
  return Unit_instance;
}
function tryClose($this) {
  return $this.b39_1.atomicfu$compareAndSet(false, true);
}
function runOrCancelPinger($this) {
  var interval = $this.e39_1;
  var tmp;
  if ($this.b39_1.kotlinx$atomicfu$value) {
    tmp = null;
  } else if (interval > 0n) {
    var tmp_0 = $this.u38_1.p38();
    var tmp_1 = $this.f39_1;
    tmp = pinger($this, tmp_0, interval, tmp_1, DefaultWebSocketSessionImpl$runOrCancelPinger$slambda($this));
  } else {
    tmp = null;
  }
  var newPinger = tmp;
  var tmp0_safe_receiver = $this.v38_1.atomicfu$getAndSet(newPinger);
  if (tmp0_safe_receiver == null)
    null;
  else
    tmp0_safe_receiver.t17();
  var tmp2_safe_receiver = newPinger == null ? null : new ChannelResult(newPinger.i17(Companion_getInstance_0().p39_1));
  if (tmp2_safe_receiver == null)
    null;
  else
    _ChannelResult___get_isSuccess__impl__odq1z9(tmp2_safe_receiver.g17_1);
  if ($this.b39_1.kotlinx$atomicfu$value && !(newPinger == null)) {
    runOrCancelPinger($this);
  }
}
function *checkMaxFrameSize($this, packet, frame, $completion) {
  var tmp = frame.s39_1.length;
  var tmp1_elvis_lhs = packet == null ? null : get_size(packet);
  var size = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
  if (fromInt(size) > $this.n38()) {
    if (packet == null)
      null;
    else {
      packet.a6();
    }
    yield* close($this, CloseReason.j38(Codes_TOO_BIG_getInstance(), 'Frame is too big: ' + size + '. Max size is ' + $this.n38().toString()), $completion);
    throw FrameTooBigException.a3a(fromInt(size));
  }
  return Unit_instance;
}
function processIncomingExtensions($this, frame) {
  ...
  var _iterator__ex2g4s = $this.b3a().l1();
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.c3a(current);
  }
  return accumulator;
}
function processOutgoingExtensions($this, frame) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.d3a(current);
  }
  return accumulator;
}
...
function DefaultWebSocketSessionImpl$start$slambda($incomingJob, $outgoingJob, this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    yield* $incomingJob.zt($completion);
    yield* $outgoingJob.zt($completion);
    this$0.x38_1.du();
    return Unit_instance;
  }, 1);
}
  ...
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
          ...
          while (yield* _iterator__ex2g4s.t16($completion)) {
            ...
            $l$block_0: {
              ...
              if (get_isTraceEnabled(this_0)) {
                ...
                this_0.l2p(tmp$ret$5);
              }
              if (e instanceof Close) {
                if (!this$0.p38().a17()) {
                  var tmp = this$0.p38();
                  var tmp1_elvis_lhs = readReason(e);
                  yield* tmp.h17(Close.o39(tmp1_elvis_lhs == null ? get_NORMAL_CLOSE() : tmp1_elvis_lhs), $completion);
                }
                closeFramePresented = true;
                return Unit_instance;
              } else {
                if (e instanceof Pong) {
                  var tmp2_safe_receiver = this$0.v38_1.kotlinx$atomicfu$value;
                  if (tmp2_safe_receiver == null)
                    null;
                  else
                    yield* tmp2_safe_receiver.h17(e, $completion);
                } else {
                  if (e instanceof Ping)
                    yield* $ponger.h17(e, $completion);
                  else {
                    ...
                    if (!e.q39_1) {
                      ...
                      writeFully(frameBody, e.s39_1);
                      break $l$block_0;
                    }
                    if (firstFrame == null) {
                      yield* this$0.z38_1.h17(processIncomingExtensions(this$0, e), $completion);
                      break $l$block_0;
                    }
                    writeFully(ensureNotNull(frameBody), e.s39_1);
                    var defragmented = Companion_getInstance_5().n3a(true, firstFrame.r39_1, readByteArray(build(frameBody)), firstFrame.u39_1, firstFrame.v39_1, firstFrame.w39_1);
                    firstFrame = null;
                    yield* this$0.z38_1.h17(processIncomingExtensions(this$0, defragmented), $completion);
                  }
                }
              }
            }
      ...
      if (!closeFramePresented) {
        yield* close(this$0, CloseReason.j38(Codes_CLOSED_ABNORMALLY_getInstance(), 'Connection was closed without close frame'), $completion);
      }
    }
    return Unit_instance;
  }, 1);
...
function DefaultWebSocketSessionImpl$runOutgoingProcessor$slambda(this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
      ...
      if ($p instanceof ClosedSendChannelException) {
        ...
        if ($p instanceof ClosedReceiveChannelException) {
          ...
          if ($p instanceof CancellationException) {
            ...
            tmp_0 = yield* /*#__NOINLINE__*/sendCloseSequence(this$0, CloseReason.j38(Codes_NORMAL_getInstance(), ''), VOID, $completion);
          } else {
            if ($p instanceof ChannelIOException) {
              ...
              if ($p instanceof Error) {
                var cause = $p;
                this$0.a39_1.cu(CancellationException.p('Failed to send frame', cause));
                yield* closeExceptionally(this$0.u38_1, cause, $completion);
                return Unit_instance;
              } else {
                throw $p;
              }
      ...
      this$0.a39_1.v17();
      yield* close(this$0.u38_1, VOID, $completion);
    }
    return Unit_instance;
  }, 1);
}
function DefaultWebSocketSessionImpl$runOrCancelPinger$slambda(this$0) {
  return constructCallableReference(function *(it, $completion) {
    yield* /*#__NOINLINE__*/sendCloseSequence(this$0, it, IOException.u2d('Ping timeout'), $completion);
    return Unit_instance;
  }, 1);
}
...
function _init_properties_DefaultWebSocketSession_kt__469s0y() {
  if (!properties_initialized_DefaultWebSocketSession_kt_6cjlhc) {
    ...
    NORMAL_CLOSE = CloseReason.j38(Codes_NORMAL_getInstance(), 'OK');
...
function readReason(_this__u8e3s4) {
  if (_this__u8e3s4.s39_1.length < 2) {
    return null;
  }
  // Inline function 'io.ktor.utils.io.core.buildPacket' call
  var builder = new Buffer();
  writeFully(builder, _this__u8e3s4.s39_1);
  var packet = builder;
  var code = packet.e2b();
  var message = readText(packet);
  return CloseReason.i38(code, message);
}
...
function pinger(_this__u8e3s4, outgoing, periodMillis, timeoutMillis, onTimeout) {
  ...
  var tmp = actorJob.oj(get_PingerCoroutineName());
  launch(_this__u8e3s4, tmp, VOID, pinger$slambda(periodMillis, timeoutMillis, onTimeout, channel, outgoing));
  var tmp_0 = ensureNotNull(_this__u8e3s4.ss().jc(Key_instance));
  tmp_0.vt(pinger$lambda(actorJob));
  return channel;
}
    ...
    try {
      ...
      $l$block: {
        ...
        try {
          ...
          while (yield* _iterator__ex2g4s.t16($completion)) {
            var e = _iterator__ex2g4s.n1();
            get_LOGGER().l2p('Received ping message, sending pong message');
            yield* $outgoing.h17(Pong.l3a(e.s39_1), $completion);
          }
          break $l$block;
        } catch ($p) {
          if ($p instanceof Error) {
...
function pinger$slambda$slambda_0($outgoing, $pingMessage, $channel) {
  return constructCallableReference(function *($this$withTimeoutOrNull, $completion) {
    get_LOGGER().l2p('WebSocket Pinger: sending ping frame');
    yield* $outgoing.h17(Ping.b3b(toByteArray($pingMessage, Charsets_getInstance().q2h_1)), $completion);
    $l$loop: while (true) {
      var msg = yield* $channel.k17($completion);
      if (decodeToString(msg.s39_1, 0, 0 + msg.s39_1.length | 0) === $pingMessage) {
        get_LOGGER().l2p('WebSocket Pinger: received valid pong frame ' + msg.toString());
        break $l$loop;
      }
      get_LOGGER().l2p('WebSocket Pinger: received invalid pong frame ' + msg.toString() + ', continue waiting');
    }
    return Unit_instance;
  }, 1);
}
function pinger$slambda($periodMillis, $timeoutMillis, $onTimeout, $channel, $outgoing) {
  return constructCallableReference(function *($this$launch, $completion) {
    get_LOGGER().l2p('Starting WebSocket pinger coroutine with period ' + $periodMillis.toString() + ' ms and timeout ' + $timeoutMillis.toString() + ' ms');
    ...
    try {
      $l$loop: while (true) {
        ...
        if (rc == null) {
          get_LOGGER().l2p('WebSocket pinger has timed out');
          yield* $onTimeout(CloseReason.j38(Codes_INTERNAL_ERROR_getInstance(), 'Ping timeout'), $completion);
          break $l$loop;
        }
      }
      tmp = Unit_instance;
...
function from(_this__u8e3s4, config) {
  ...
  var tmp;
  if (config.e3b_1 === 2147483647) {
    tmp = Channel(2147483647);
  } else if (config.f3b_1.equals(ChannelOverflow_SUSPEND_getInstance())) {
    tmp = Channel(config.e3b_1, BufferOverflow_SUSPEND_getInstance());
  } else if (config.f3b_1.equals(ChannelOverflow_CLOSE_getInstance())) {
    tmp = new BoundedChannel(config.e3b_1);
  } else {
    // Inline function 'kotlin.error' call
...
function BoundedChannel$Companion$createDelegate$lambda($channel) {
  return (it) => {
    ...
    if (!tmp_0.a17()) {
      ...
      tmp_1.r17(ChannelOverflowException.k3b('Channel overflowed'));
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function parametersToString($this) {
  return $this.v3b_1.j1() ? '' : '; ' + joinToString($this.v3b_1, ';');
}
...
function *close(_this__u8e3s4, reason, $completion) {
  reason = reason === VOID ? CloseReason.j38(Codes_NORMAL_getInstance(), '') : reason;
  try {
    yield* _this__u8e3s4.q38(Close.o39(reason), $completion);
...
function *closeExceptionally(_this__u8e3s4, cause, $completion) {
  ...
  if (cause instanceof CancellationException) {
    tmp = CloseReason.j38(Codes_NORMAL_getInstance(), '');
  } else {
    tmp = CloseReason.j38(Codes_INTERNAL_ERROR_getInstance(), cause.toString());
  }
  var reason = tmp;
...
protoOf(DefaultWebSocketSessionImpl).q38 = send;
...
protoOf(BoundedChannel).t17 = close$default;
protoOf(BoundedChannel).v17 = cancel$default;
...
initMetadataForClass(Close, 'Close', Close.s3c);

...
class Companion {
  constructor() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = element.e38_1;
      destination.z3(tmp$ret$2, element);
    }
    tmp.f38_1 = destination;
    this.g38_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  h38(code) {
    return this.f38_1.w3(code);
  }
}
...
class CloseReason {
  constructor(code, message) {
    return new.target.k38(code, message);
  }
  static k38(code, message) {
    var $this = createThis(this);
    $this.i38_1 = code;
    $this.j38_1 = message;
    return $this;
  }
  static l38(code, message) {
    return this.k38(code.e38_1, message);
  }
  m38() {
    return Companion_getInstance().h38(this.i38_1);
  }
  toString() {
    var tmp0_elvis_lhs = this.m38();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.i38_1 : tmp0_elvis_lhs) + ', message=' + this.j38_1 + ')';
  }
  hashCode() {
    var result = this.i38_1;
    result = imul(result, 31) + getStringHashCode(this.j38_1) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
...
function *send(frame, $completion) {
  yield* this.r38().h17(frame, $completion);
...
class Companion_0 {
  constructor() {
    ...
    this.r39_1 = Pong.n3a(new Int8Array(0), NonDisposableHandle_instance);
  }
}
class DefaultWebSocketSessionImpl {
  constructor(raw, pingIntervalMillis, timeoutMillis, incomingFramesConfig, outgoingFramesConfig) {
    ...
    this.w38_1 = raw;
    this.x38_1 = atomic$ref$1(null);
    this.y38_1 = CompletableDeferred();
    this.z38_1 = Job();
    this.a39_1 = this.w38_1.ss().mj(Key_instance).oj(this.z38_1).oj(new CoroutineName('ws-default'));
    this.b39_1 = from(Factory_getInstance(), incomingFramesConfig);
    this.c39_1 = from(Factory_getInstance(), outgoingFramesConfig);
    this.d39_1 = atomic$boolean$1(false);
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.e39_1 = ArrayList.p2();
    this.f39_1 = atomic$boolean$1(false);
    this.g39_1 = pingIntervalMillis;
    this.h39_1 = timeoutMillis;
    this.i39_1 = this.y38_1;
  }
  ss() {
    return this.a39_1;
  }
  ...
  o38(value) {
    this.w38_1.o38(value);
  }
  p38() {
    return this.w38_1.p38();
  }
  n38(negotiatedExtensions) {
    if (!this.f39_1.atomicfu$compareAndSet(false, true)) {
    ...
    if (get_isTraceEnabled(this_0)) {
      ...
      this_0.m2p(tmp$ret$2);
    }
    this.e39_1.o2(negotiatedExtensions);
    runOrCancelPinger(this);
    var incomingJob = runIncomingProcessor(this, ponger(this, this.r38()));
  ...
  *v2f($completion) {
    yield* this.w38_1.v2f($completion);
    return Unit_instance;
  }
}
...
class FrameTooBigException extends Exception {
  constructor(frameSize, cause) {
    return new.target.c3a(frameSize, cause);
  }
  static c3a(frameSize, cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.jd(cause);
    captureStack($this, $this.b3a_1);
    $this.a3a_1 = frameSize;
    delete $this.message;
    return $this;
  }
  r() {
    var sizeSuffix = this.a3a_1 >= 0n ? ': ' + this.a3a_1.toString() : '';
    return 'Frame is too big' + sizeSuffix;
  }
  iz() {
    return FrameTooBigException.c3a(this.a3a_1, this);
  }
  get message() {
    return this.r();
  }
...
class Companion_2 {
  constructor() {
    ...
    this_0.u38_1 = this_0.e3b();
    this_0.v38_1 = this_0.e3b();
    tmp.t38_1 = this_0;
  }
}
class WebSocketChannelsConfig {
  constructor() {
    ...
    this.u38_1 = Companion_getInstance_3().f3b_1;
    this.v38_1 = Companion_getInstance_3().f3b_1;
  }
  e3b() {
    return Companion_getInstance_3().f3b_1;
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.f3b_1 = new ChannelConfig(2147483647, ChannelOverflow_SUSPEND_getInstance());
  }
}
class ChannelConfig {
  constructor(capacity, onOverflow) {
    ...
    this.g3b_1 = capacity;
    this.h3b_1 = onOverflow;
  }
  i3b() {
    return this.h3b_1.equals(ChannelOverflow_SUSPEND_getInstance()) && !(this.g3b_1 === 2147483647);
  }
}
...
class BoundedChannel {
  constructor(capacity, delegate) {
    delegate = delegate === VOID ? Companion_instance_4.n3b(capacity) : delegate;
    this.o3b_1 = delegate;
  }
  p3b(element) {
    var result = this.o3b_1.i17(element);
    if (!_ChannelResult___get_isSuccess__impl__odq1z9(result) && !_ChannelResult___get_isClosed__impl__mg7kuu(result)) {
      this.r17(ChannelOverflowException.m3b('Channel overflowed'));
    }
    return result;
  }
  i17(element) {
    return this.p3b(element);
  }
  *q3b(element, $completion) {
    yield* this.o3b_1.h17(element, $completion);
    return Unit_instance;
  }
  h17(element, $completion) {
    return this.q3b(element, $completion);
  }
  r17(cause) {
    return this.o3b_1.r17(cause);
  }
  a17() {
    return this.o3b_1.a17();
  }
  *r3b($completion) {
    return yield* this.o3b_1.k17($completion);
  }
  k17($completion) {
    return this.r3b($completion);
  }
  l1() {
    return this.o3b_1.l1();
  }
  cu(cause) {
    this.o3b_1.cu(cause);
  }
...
class ChannelOverflowException extends RuntimeException {
  constructor(message) {
    return new.target.m3b(message);
  }
  static m3b(message) {
    var $this = this.ga(message);
    captureStack($this, $this.l3b_1);
    return $this;
  }
}
...
class WebSocketExtensionsConfig {
  constructor() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.u3b_1 = ArrayList.p2();
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp_0.v3b_1 = [false, false, false];
  }
  l2t() {
...
class WebSocketExtensionHeader {
  constructor(name, parameters) {
    this.w3b_1 = name;
    this.x3b_1 = parameters;
  }
  toString() {
    return this.w3b_1 + ' ' + parametersToString(this);
  }
}
class Frame {
  static g3c(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    var $this = createThis(this);
    $this.s39_1 = fin;
    $this.t39_1 = frameType;
    $this.u39_1 = data;
    $this.v39_1 = disposableHandle;
    $this.w39_1 = rsv1;
    $this.x39_1 = rsv2;
    $this.y39_1 = rsv3;
    return $this;
  ...
  toString() {
    return 'Frame ' + this.t39_1.toString() + ' (fin=' + this.s39_1 + ', buffer len = ' + this.u39_1.length + ')';
  }
}
class Binary extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.f3c(fin, data, rsv1, rsv2, rsv3);
  }
  static f3c(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.g3c(fin, FrameType_BINARY_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static h3c(fin, data) {
    return this.f3c(fin, data, false, false, false);
  }
}
class Text extends Frame {
  constructor(fin, data, rsv1, rsv2, rsv3) {
    return new.target.p3c(fin, data, rsv1, rsv2, rsv3);
  }
  static p3c(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.g3c(fin, FrameType_TEXT_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static q3c(fin, data) {
    return this.p3c(fin, data, false, false, false);
  }
  static r3c(text) {
    return this.q3c(true, toByteArray(text));
  }
}
class Close extends Frame {
  constructor(data) {
    return new.target.s3c(data);
  }
  static s3c(data) {
    return this.g3c(true, FrameType_CLOSE_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
  static q39(reason) {
    // Inline function 'io.ktor.utils.io.core.buildPacket' call
    var builder = new Buffer();
    builder.m2c(reason.i38_1);
    writeText(builder, reason.j38_1);
    return this.t3c(builder);
  }
  static t3c(packet) {
    return this.s3c(readByteArray(packet));
  }
  static u3c() {
    return this.s3c(Companion_getInstance_5().o3a_1);
  }
}
class Ping extends Frame {
  constructor(data) {
    return new.target.d3b(data);
  }
  static d3b(data) {
    return this.g3c(true, FrameType_PING_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
}
class Pong extends Frame {
  constructor(data, disposableHandle) {
    return new.target.n3a(data, disposableHandle);
  }
  static n3a(data, disposableHandle) {
    disposableHandle = disposableHandle === VOID ? NonDisposableHandle_instance : disposableHandle;
    return this.g3c(true, FrameType_PONG_getInstance(), data, disposableHandle, false, false, false);
  }
}
class Companion_5 {
  constructor() {
    Companion_instance_5 = this;
    this.o3a_1 = new Int8Array(0);
  }
  p3a(fin, frameType, data, rsv1, rsv2, rsv3) {
    var tmp;
    switch (frameType.s1_1) {
      case 1:
        tmp = Binary.f3c(fin, data, rsv1, rsv2, rsv3);
        break;
      case 0:
        tmp = Text.p3c(fin, data, rsv1, rsv2, rsv3);
        break;
      case 2:
        tmp = Close.s3c(data);
        break;
      case 3:
        ...
        break;
      case 4:
        tmp = Pong.n3a(data, NonDisposableHandle_instance);
        break;
      default:
...
function DefaultWebSocketSession_0(session, pingIntervalMillis, timeoutMillis, channelsConfig) {
  ...
  channelsConfig = channelsConfig === VOID ? Companion_getInstance_2().t38_1 : channelsConfig;
  _init_properties_DefaultWebSocketSession_kt__469s0y();
  ...
  return new DefaultWebSocketSessionImpl(session, pingIntervalMillis, timeoutMillis, channelsConfig.u38_1, channelsConfig.v38_1);
}
...
function *outgoingProcessorLoop($this, $completion) {
  var _iterator__ex2g4s = $this.c39_1.l1();
  $l$loop: while (yield* _iterator__ex2g4s.t16($completion)) {
    ...
    yield* $this.w38_1.r38().h17(processedFrame, $completion);
  }
  return Unit_instance;
}
function *sendCloseSequence($this, reason, exception, $completion) {
  ...
  $this.z38_1.xy();
  var reasonToSend = reason == null ? CloseReason.l38(Codes_NORMAL_getInstance(), '') : reason;
  try {
    runOrCancelPinger($this);
    if (!(reasonToSend.i38_1 === Codes_CLOSED_ABNORMALLY_getInstance().e38_1)) {
      yield* $this.w38_1.r38().h17(Close.q39(reasonToSend), $completion);
    }
  }finally {
    $this.y38_1.vy(reasonToSend);
    if (!(exception == null)) {
      $this.c39_1.r17(exception);
      $this.b39_1.r17(exception);
    }
  }
  return Unit_instance;
}
function tryClose($this) {
  return $this.d39_1.atomicfu$compareAndSet(false, true);
}
function runOrCancelPinger($this) {
  var interval = $this.g39_1;
  var tmp;
  if ($this.d39_1.kotlinx$atomicfu$value) {
    tmp = null;
  } else if (interval > 0n) {
    var tmp_0 = $this.w38_1.r38();
    var tmp_1 = $this.h39_1;
    tmp = pinger($this, tmp_0, interval, tmp_1, DefaultWebSocketSessionImpl$runOrCancelPinger$slambda($this));
  } else {
    tmp = null;
  }
  var newPinger = tmp;
  var tmp0_safe_receiver = $this.x38_1.atomicfu$getAndSet(newPinger);
  if (tmp0_safe_receiver == null)
    null;
  else
    tmp0_safe_receiver.t17();
  var tmp2_safe_receiver = newPinger == null ? null : new ChannelResult(newPinger.i17(Companion_getInstance_0().r39_1));
  if (tmp2_safe_receiver == null)
    null;
  else
    _ChannelResult___get_isSuccess__impl__odq1z9(tmp2_safe_receiver.g17_1);
  if ($this.d39_1.kotlinx$atomicfu$value && !(newPinger == null)) {
    runOrCancelPinger($this);
  }
}
function *checkMaxFrameSize($this, packet, frame, $completion) {
  var tmp = frame.u39_1.length;
  var tmp1_elvis_lhs = packet == null ? null : get_size(packet);
  var size = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
  if (fromInt(size) > $this.p38()) {
    if (packet == null)
      null;
    else {
      packet.a6();
    }
    yield* close($this, CloseReason.l38(Codes_TOO_BIG_getInstance(), 'Frame is too big: ' + size + '. Max size is ' + $this.p38().toString()), $completion);
    throw FrameTooBigException.c3a(fromInt(size));
  }
  return Unit_instance;
}
function processIncomingExtensions($this, frame) {
  ...
  var _iterator__ex2g4s = $this.d3a().l1();
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.e3a(current);
  }
  return accumulator;
}
function processOutgoingExtensions($this, frame) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    var current = accumulator;
    accumulator = element.f3a(current);
  }
  return accumulator;
}
  ...
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
          ...
          while (yield* _iterator__ex2g4s.t16($completion)) {
            ...
            $l$block_0: {
              ...
              if (get_isTraceEnabled(this_0)) {
                ...
                this_0.m2p(tmp$ret$5);
              }
              if (e instanceof Close) {
                if (!this$0.r38().a17()) {
                  var tmp = this$0.r38();
                  var tmp1_elvis_lhs = readReason(e);
                  yield* tmp.h17(Close.q39(tmp1_elvis_lhs == null ? get_NORMAL_CLOSE() : tmp1_elvis_lhs), $completion);
                }
                closeFramePresented = true;
                return Unit_instance;
              } else {
                if (e instanceof Pong) {
                  var tmp2_safe_receiver = this$0.x38_1.kotlinx$atomicfu$value;
                  if (tmp2_safe_receiver == null)
                    null;
                  else
                  ...
                  if (e instanceof Ping)
                    ...
                    if (!e.s39_1) {
                      ...
                      writeFully(frameBody, e.u39_1);
                      break $l$block_0;
                    }
                    if (firstFrame == null) {
                      yield* this$0.b39_1.h17(processIncomingExtensions(this$0, e), $completion);
                      break $l$block_0;
                    }
                    writeFully(ensureNotNull(frameBody), e.u39_1);
                    var defragmented = Companion_getInstance_5().p3a(true, firstFrame.t39_1, readByteArray(build(frameBody)), firstFrame.w39_1, firstFrame.x39_1, firstFrame.y39_1);
                    firstFrame = null;
                    yield* this$0.b39_1.h17(processIncomingExtensions(this$0, defragmented), $completion);
                  }
                }
              }
            }
      ...
      if (!closeFramePresented) {
        yield* close(this$0, CloseReason.l38(Codes_CLOSED_ABNORMALLY_getInstance(), 'Connection was closed without close frame'), $completion);
      }
    }
    return Unit_instance;
  }, 1);
...
function DefaultWebSocketSessionImpl$runOutgoingProcessor$slambda(this$0) {
  return constructCallableReference(function *($this$launch, $completion) {
    ...
    try {
      ...
      if ($p instanceof ClosedSendChannelException) {
        ...
        if ($p instanceof ClosedReceiveChannelException) {
          ...
          if ($p instanceof CancellationException) {
            ...
            tmp_0 = yield* /*#__NOINLINE__*/sendCloseSequence(this$0, CloseReason.l38(Codes_NORMAL_getInstance(), ''), VOID, $completion);
          } else {
            if ($p instanceof ChannelIOException) {
              ...
              if ($p instanceof Error) {
                var cause = $p;
                this$0.c39_1.cu(CancellationException.p('Failed to send frame', cause));
                yield* closeExceptionally(this$0.w38_1, cause, $completion);
                return Unit_instance;
              } else {
                throw $p;
              }
      ...
      this$0.c39_1.v17();
      yield* close(this$0.w38_1, VOID, $completion);
    }
    return Unit_instance;
  }, 1);
}
...
function _init_properties_DefaultWebSocketSession_kt__469s0y() {
  if (!properties_initialized_DefaultWebSocketSession_kt_6cjlhc) {
    ...
    NORMAL_CLOSE = CloseReason.l38(Codes_NORMAL_getInstance(), 'OK');
...
function readReason(_this__u8e3s4) {
  if (_this__u8e3s4.u39_1.length < 2) {
    return null;
  }
  // Inline function 'io.ktor.utils.io.core.buildPacket' call
  var builder = new Buffer();
  writeFully(builder, _this__u8e3s4.u39_1);
  var packet = builder;
  var code = packet.e2b();
  var message = readText(packet);
  return CloseReason.k38(code, message);
}
    ...
    try {
      ...
      $l$block: {
        ...
        try {
          ...
          while (yield* _iterator__ex2g4s.t16($completion)) {
            var e = _iterator__ex2g4s.n1();
            get_LOGGER().m2p('Received ping message, sending pong message');
            yield* $outgoing.h17(Pong.n3a(e.u39_1), $completion);
          }
          break $l$block;
        } catch ($p) {
          if ($p instanceof Error) {
...
function pinger$slambda$slambda_0($outgoing, $pingMessage, $channel) {
  return constructCallableReference(function *($this$withTimeoutOrNull, $completion) {
    get_LOGGER().m2p('WebSocket Pinger: sending ping frame');
    yield* $outgoing.h17(Ping.d3b(toByteArray($pingMessage, Charsets_getInstance().q2h_1)), $completion);
    $l$loop: while (true) {
      var msg = yield* $channel.k17($completion);
      if (decodeToString(msg.u39_1, 0, 0 + msg.u39_1.length | 0) === $pingMessage) {
        get_LOGGER().m2p('WebSocket Pinger: received valid pong frame ' + msg.toString());
        break $l$loop;
      }
      get_LOGGER().m2p('WebSocket Pinger: received invalid pong frame ' + msg.toString() + ', continue waiting');
    }
    return Unit_instance;
  }, 1);
}
function pinger$slambda($periodMillis, $timeoutMillis, $onTimeout, $channel, $outgoing) {
  return constructCallableReference(function *($this$launch, $completion) {
    get_LOGGER().m2p('Starting WebSocket pinger coroutine with period ' + $periodMillis.toString() + ' ms and timeout ' + $timeoutMillis.toString() + ' ms');
    ...
    try {
      $l$loop: while (true) {
        ...
        if (rc == null) {
          get_LOGGER().m2p('WebSocket pinger has timed out');
          yield* $onTimeout(CloseReason.l38(Codes_INTERNAL_ERROR_getInstance(), 'Ping timeout'), $completion);
          break $l$loop;
        }
      }
      tmp = Unit_instance;
...
function from(_this__u8e3s4, config) {
  ...
  var tmp;
  if (config.g3b_1 === 2147483647) {
    tmp = Channel(2147483647);
  } else if (config.h3b_1.equals(ChannelOverflow_SUSPEND_getInstance())) {
    tmp = Channel(config.g3b_1, BufferOverflow_SUSPEND_getInstance());
  } else if (config.h3b_1.equals(ChannelOverflow_CLOSE_getInstance())) {
    tmp = new BoundedChannel(config.g3b_1);
  } else {
    // Inline function 'kotlin.error' call
...
function BoundedChannel$Companion$createDelegate$lambda($channel) {
  return (it) => {
    ...
    if (!tmp_0.a17()) {
      ...
      tmp_1.r17(ChannelOverflowException.m3b('Channel overflowed'));
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function parametersToString($this) {
  return $this.x3b_1.j1() ? '' : '; ' + joinToString($this.x3b_1, ';');
}
...
function *close(_this__u8e3s4, reason, $completion) {
  reason = reason === VOID ? CloseReason.l38(Codes_NORMAL_getInstance(), '') : reason;
  try {
    yield* _this__u8e3s4.s38(Close.q39(reason), $completion);
...
function *closeExceptionally(_this__u8e3s4, cause, $completion) {
  ...
  if (cause instanceof CancellationException) {
    tmp = CloseReason.l38(Codes_NORMAL_getInstance(), '');
  } else {
    tmp = CloseReason.l38(Codes_INTERNAL_ERROR_getInstance(), cause.toString());
  }
  var reason = tmp;
...
protoOf(DefaultWebSocketSessionImpl).s38 = send;
...
initMetadataForClass(Close, 'Close', Close.u3c);

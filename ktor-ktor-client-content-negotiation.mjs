...
class ConverterRegistration {
  constructor(converter, contentTypeToSend, contentTypeMatcher) {
    this.b5c_1 = converter;
    this.c5c_1 = contentTypeToSend;
    this.d5c_1 = contentTypeMatcher;
  }
}
class ContentNegotiationConfig$defaultMatcher$1 {
  ...
  f5c(contentType) {
    return contentType.i2t(this.e5c_1);
  }
}
class ContentNegotiationConfig {
  constructor() {
    this.g5c_1 = toMutableSet(plus(get_DefaultIgnoredTypes(), get_DefaultCommonIgnoredTypes()));
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.h5c_1 = ArrayList.p2();
    this.i5c_1 = null;
  }
  c3d(contentType, converter, configuration) {
    var matcher = contentType.i2t(Application_getInstance().v2q_1) ? JsonContentTypeMatcher_instance : defaultMatcher(this, contentType);
    this.j5c(contentType, converter, matcher, configuration);
  }
  j5c(contentTypeToSend, converter, contentTypeMatcher, configuration) {
    // Inline function 'kotlin.apply' call
    configuration(converter);
    var registration = new ConverterRegistration(converter, contentTypeToSend, contentTypeMatcher);
    this.h5c_1.d2(registration);
  }
}
class ContentConverterException extends Exception {
  constructor(message) {
    return new.target.m5c(message);
  }
  static m5c(message) {
...
class JsonContentTypeMatcher {
  f5c(contentType) {
    if (contentType.i2t(Application_getInstance().v2q_1)) {
      return true;
    }
    var value = contentType.h2t().toString();
    return Application_getInstance().p2r(value) && endsWith(value, '+json', true);
  }
}
//endregion
function get_LOGGER() {
...
function ContentNegotiation$lambda($this$createClientPlugin) {
  _init_properties_ContentNegotiation_kt__o183go();
  var registrations = $this$createClientPlugin.f3k_1.h5c_1;
  var ignoredTypes = $this$createClientPlugin.f3k_1.g5c_1;
  $this$createClientPlugin.r3p(ContentNegotiation$lambda$slambda(registrations, $this$createClientPlugin, ignoredTypes));
  $this$createClientPlugin.p3m(ContentNegotiation$lambda$slambda_0(ignoredTypes, registrations, $this$createClientPlugin));
  return Unit_instance;
}
function ContentNegotiation$lambda$convertRequest$lambda(it) {
  _init_properties_ContentNegotiation_kt__o183go();
  return toString(it.b5c_1);
}
function *invoke$convertRequest(registrations, $this_createClientPlugin, ignoredTypes, request, body, $completion) {
  var tmp;
  if (request.p3f_1.w2i(get_ExcludedContentTypes())) {
    var excluded = request.p3f_1.u2i(get_ExcludedContentTypes());
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      $l$block_0: {
        ...
        while (_iterator__ex2g4s_0.m1()) {
          ...
          if (element.c5c_1.i2t(element_0)) {
            tmp$ret$3 = false;
            break $l$block_0;
          }
        }
  ...
  var tmp0_elvis_lhs = request.m3f_1.f2l('Accept');
  ...
  while (_iterator__ex2g4s_1.m1()) {
    ...
    $l$block_2: {
      ...
      while (_iterator__ex2g4s_2.m1()) {
        ...
        if (Companion_getInstance().mq(element_2).i2t(element_1.c5c_1)) {
          tmp$ret$8 = false;
          break $l$block_2;
        }
      }
    ...
    if (tmp$ret$8) {
      var qValue = $this_createClientPlugin.f3k_1.i5c_1;
      var contentTypeToSend = qValue == null ? element_1.c5c_1 : element_1.c5c_1.f2t('q', qValue.toString());
      get_LOGGER().m2p('Adding Accept=' + contentTypeToSend.toString() + ' header for ' + request.k3f_1.toString());
  ...
  if (tmp_2) {
    get_LOGGER().m2p('Body type ' + toString(getKClassFromExpression(body)) + ' is in ignored types. ' + ('Skipping ContentNegotiation for ' + request.k3f_1.toString() + '.'));
    return null;
  }
  ...
  if (tmp0_elvis_lhs_0 == null) {
    ...
    get_LOGGER().m2p("Request doesn't have Content-Type header. Skipping ContentNegotiation for " + request.k3f_1.toString() + '.');
    return null;
  } else {
  ...
  if (body instanceof Unit) {
    get_LOGGER().m2p('Sending empty body for ' + request.k3f_1.toString());
    request.m3f_1.m2l('Content-Type');
  ...
  while (_iterator__ex2g4s_4.m1()) {
    ...
    if (element_4.d5c_1.f5c(contentType_0)) {
  ...
  if (tmp1_elvis_lhs == null) {
    // Inline function 'kotlin.run' call
    get_LOGGER().m2p('None of the registered converters match request Content-Type=' + contentType_0.toString() + '. ' + ('Skipping ContentNegotiation for ' + request.k3f_1.toString() + '.'));
    return null;
  } else {
  ...
  if (request.e3q() == null) {
    get_LOGGER().m2p('Request has unknown body type. Skipping ContentNegotiation for ' + request.k3f_1.toString() + '.');
    return null;
  }
  request.m3f_1.m2l('Content-Type');
  var tmp$ret$22;
  $l$block_5: {
    ...
    while (_iterator__ex2g4s_5.m1()) {
      ...
      var tmp_8 = ensureNotNull(request.e3q());
      // Inline function 'kotlin.takeIf' call
      var tmp_9;
      ...
      var result = yield* element_5.b5c_1.n5c(contentType_0, tmp_7, tmp_8, tmp$ret$24, $completion);
      if (!(result == null)) {
        get_LOGGER().m2p('Converted request body using ' + toString(element_5.b5c_1) + ' for ' + request.k3f_1.toString());
      }
      var result_0 = result;
      if (!(result_0 == null)) {
        tmp$ret$22 = result_0;
  ...
  if (tmp2_elvis_lhs == null) {
    ...
    throw ContentConverterException.m5c(tmp_11 + joinToString(matchingRegistrations, VOID, VOID, VOID, VOID, VOID, ContentNegotiation$lambda$convertRequest$lambda));
  } else {
...
function *invoke$convertResponse(ignoredTypes, registrations, $this_createClientPlugin, requestUrl, info, body, responseContentType, charset, $completion) {
  ...
  if (!isInterface(body, ByteReadChannel)) {
    get_LOGGER().m2p('Response body is already transformed. Skipping ContentNegotiation for ' + requestUrl.toString() + '.');
    return null;
  }
  if (ignoredTypes.q3(info.a2p_1)) {
    get_LOGGER().m2p('Response body type ' + toString(info.a2p_1) + ' is in ignored types. ' + ('Skipping ContentNegotiation for ' + requestUrl.toString() + '.'));
    return null;
  }
  // Inline function 'kotlin.collections.filter' call
  // Inline function 'kotlin.collections.filterTo' call
  ...
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
    if (element.d5c_1.f5c(responseContentType)) {
      destination.d2(element);
    }
  }
  ...
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.run' call
    get_LOGGER().m2p('None of the registered converters match response with Content-Type=' + responseContentType.toString() + '. ' + ('Skipping ContentNegotiation for ' + requestUrl.toString() + '.'));
    return null;
  } else {
  ...
  if (!isInterface(result, ByteReadChannel)) {
    get_LOGGER().m2p('Response body was converted to ' + toString(getKClassFromExpression(result)) + ' for ' + requestUrl.toString() + '.');
  }
  return result;
}
...
function ContentNegotiation$lambda$slambda_0($ignoredTypes, $registrations, $this_createClientPlugin) {
  return constructCallableReference(function *($this$transformResponseBody, response, body, info, $completion) {
    ...
    var contentType = tmp;
    var charset = suitableCharset(get_request(response).j2y());
    return yield* /*#__NOINLINE__*/invoke$convertResponse($ignoredTypes, $registrations, $this_createClientPlugin, get_request(response).l3g(), info, body, contentType, charset, $completion);
  }, 4);
}
...
protoOf(ContentNegotiationConfig).d3d = register$default;

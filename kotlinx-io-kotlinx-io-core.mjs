...
function write$default(source, startIndex, endIndex, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.a2c(source, startIndex, endIndex);
    tmp = Unit_instance;
  } else {
    tmp = $super.a2c.call(this, source, startIndex, endIndex);
  }
  return tmp;
}
class Buffer {
  ...
  s2a(byteCount) {
    ...
    if (this.g2() < byteCount) {
      throw EOFException.p2a("Buffer doesn't contain required number of bytes (size: " + this.g2().toString() + ', required: ' + byteCount.toString() + ')');
    }
  }
  t2a(byteCount) {
    // Inline function 'kotlin.require' call
  ...
  u2a() {
    ...
    var v = segment.d2b();
    this.l2a_1 = subtract(this.l2a_1, 1n);
    if (segmentSize === 1) {
      this.c2b();
    }
    return v;
  ...
  e2b() {
    ...
    if (segmentSize < 2) {
      ...
      var tmp_0 = (this.u2a() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.u2a() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.f2b();
    this.l2a_1 = subtract(this.l2a_1, 2n);
    if (segmentSize === 2) {
      this.c2b();
    }
    return v;
  ...
  h2b(out, startIndex, endIndex) {
    checkBounds(this.g2(), startIndex, endIndex);
    if (startIndex === endIndex)
      return Unit_instance;
    var currentOffset = startIndex;
    var remainingByteCount = subtract(endIndex, startIndex);
    out.l2a_1 = add(out.l2a_1, remainingByteCount);
    var s = this.j2a_1;
    while (currentOffset >= fromInt(ensureNotNull(s).x2a_1 - s.w2a_1 | 0)) {
      currentOffset = subtract(currentOffset, fromInt(s.x2a_1 - s.w2a_1 | 0));
      s = s.a2b_1;
    }
    while (remainingByteCount > 0n) {
      var copy = ensureNotNull(s).i2b();
      copy.w2a_1 = copy.w2a_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.w2a_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.x2a_1;
      tmp.x2a_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.j2a_1 == null) {
        out.j2a_1 = copy;
        out.k2a_1 = copy;
      } else if (false) {
        out.k2a_1 = ensureNotNull(out.k2a_1).j2b(copy).k2b();
        if (ensureNotNull(out.k2a_1).b2b_1 == null) {
          out.j2a_1 = out.k2a_1;
        }
      } else {
        out.k2a_1 = ensureNotNull(out.k2a_1).j2b(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.x2a_1 - copy.w2a_1 | 0));
      currentOffset = 0n;
      s = s.a2b_1;
    }
  }
  l2b() {
    ...
    if (result === 0n)
      return 0n;
    var tail = ensureNotNull(this.k2a_1);
    if (tail.x2a_1 < 8192 && tail.z2a_1) {
      result = subtract(result, fromInt(tail.x2a_1 - tail.w2a_1 | 0));
    }
    return result;
  }
  m2b(position) {
    ...
    if (position === 0n) {
      return ensureNotNull(this.j2a_1).n2b(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.j2a_1 == null) {
        return ensureNotNull(null).n2b(convertToInt(subtract(position, -1n)));
      }
      if (subtract(this.g2(), position) < position) {
        var s = this.k2a_1;
        var offset = this.g2();
        $l$loop: while (!(s == null) && offset > position) {
          offset = subtract(offset, fromInt(s.x2a_1 - s.w2a_1 | 0));
          if (offset <= position)
            break $l$loop;
          s = s.b2b_1;
        }
        var tmp0 = s;
        var offset_0 = offset;
        return ensureNotNull(tmp0).n2b(convertToInt(subtract(position, offset_0)));
      } else {
        var s_0 = this.j2a_1;
        var offset_1 = 0n;
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.x2a_1 - s_0.w2a_1 | 0;
        ...
        return ensureNotNull(tmp0_1).n2b(convertToInt(subtract(position, offset_2)));
      }
    }
  }
  c4() {
    return this.o2b(this.g2());
  }
  o2b(byteCount) {
    ...
    while (remainingByteCount > 0n) {
      ...
      var tmp;
      if (tmp0_elvis_lhs == null) {
        throw EOFException.p2a('Buffer exhausted before skipping ' + byteCount.toString() + ' bytes.');
      } else {
        tmp = tmp0_elvis_lhs;
      }
      var head = tmp;
      ...
      var b = head.x2a_1 - head.w2a_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = tmp0 <= b_0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.l2a_1 = subtract(this.l2a_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.w2a_1 = head.w2a_1 + toSkip | 0;
      if (head.w2a_1 === head.x2a_1) {
        this.c2b();
      }
    }
  }
  p2b(sink, startIndex, endIndex) {
    ...
    s.q2b(sink, startIndex, startIndex + toCopy | 0);
    this.l2a_1 = subtract(this.l2a_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.c2b();
    }
    return toCopy;
  ...
  t2b(sink, byteCount) {
    ...
    if (this.g2() < byteCount) {
      sink.s2b(this, this.g2());
      throw EOFException.p2a('Buffer exhausted before writing ' + byteCount.toString() + ' bytes. Only ' + this.g2().toString() + ' bytes were written.');
    }
    sink.s2b(this, byteCount);
  }
  u2b(sink) {
  ...
  w2b(minimumCapacity) {
    ...
    if (this.k2a_1 == null) {
      var result = SegmentPool_instance.z2b();
      this.j2a_1 = result;
      this.k2a_1 = result;
      return result;
    }
    var t = ensureNotNull(this.k2a_1);
    if ((t.x2a_1 + minimumCapacity | 0) > 8192 || !t.z2a_1) {
      var newTail = t.j2b(SegmentPool_instance.z2b());
      this.k2a_1 = newTail;
      return newTail;
    }
    return t;
  }
  a2c(source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.b2c();
      var toCopy = Math.min(tmp0, b);
      tail.c2c(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.l2a_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.l2a_1 = add(tmp0_0, fromInt(other));
  }
  e2c(source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(byteCount >= 0n)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      var read = source.r2b(this, remainingByteCount);
      if (read === -1n) {
        throw EOFException.p2a('Source exhausted before reading ' + byteCount.toString() + ' bytes. ' + ('Only ' + subtract(byteCount, remainingByteCount).toString() + ' were read.'));
      }
      remainingByteCount = subtract(remainingByteCount, read);
    }
  }
  s2b(source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException.c2(toString(message));
    }
    checkOffsetAndCount(source.l2a_1, 0n, byteCount);
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      if (remainingByteCount < fromInt(ensureNotNull(source.j2a_1).g2())) {
        var tail = this.k2a_1;
        var tmp;
        if (!(tail == null) && tail.z2a_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.x2a_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.f2c() ? 0 : tail.w2a_1;
          tmp = subtract(tmp0_0, fromInt(other_0)) <= 8192n;
        } else {
          tmp = false;
        }
        if (tmp) {
          ensureNotNull(source.j2a_1).h2c(tail, convertToInt(remainingByteCount));
          source.l2a_1 = subtract(source.l2a_1, remainingByteCount);
          this.l2a_1 = add(this.l2a_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.j2a_1 = ensureNotNull(source.j2a_1).g2c(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.j2a_1);
      var movedByteCount = fromInt(segmentToMove.g2());
      source.j2a_1 = segmentToMove.i2c();
      if (source.j2a_1 == null) {
        source.k2a_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.j2a_1 == null) {
        this.j2a_1 = segmentToMove;
        this.k2a_1 = segmentToMove;
      } else if (true) {
        this.k2a_1 = ensureNotNull(this.k2a_1).j2b(segmentToMove).k2b();
        if (ensureNotNull(this.k2a_1).b2b_1 == null) {
          this.j2a_1 = this.k2a_1;
        }
      } else {
        this.k2a_1 = ensureNotNull(this.k2a_1).j2b(segmentToMove);
      }
      source.l2a_1 = subtract(source.l2a_1, movedByteCount);
      this.l2a_1 = add(this.l2a_1, movedByteCount);
  ...
  j2c(source) {
    ...
    $l$loop: while (true) {
      var readCount = source.r2b(this, 8192n);
      if (readCount === -1n)
        break $l$loop;
  ...
  k2c(byte) {
    this.w2b(1).l2c(byte);
    this.l2a_1 = add(this.l2a_1, 1n);
  }
  m2c(short) {
    this.w2b(2).n2c(short);
    this.l2a_1 = add(this.l2a_1, 2n);
  }
  a6() {
    return Unit_instance;
  }
  toString() {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.g2()) {
        ...
        var b_0 = tmp0.o2c(segment, _unary__edvuaz);
  ...
  c2b() {
    var oldHead = ensureNotNull(this.j2a_1);
    var nextHead = oldHead.a2b_1;
    this.j2a_1 = nextHead;
    if (nextHead == null) {
      this.k2a_1 = null;
    } else {
    ...
    oldHead.a2b_1 = null;
    SegmentPool_instance.p2c(oldHead);
  }
  q2c() {
    var oldTail = ensureNotNull(this.k2a_1);
    var newTail = oldTail.b2b_1;
    this.k2a_1 = newTail;
    if (newTail == null) {
      this.j2a_1 = null;
    } else {
    ...
    oldTail.b2b_1 = null;
    SegmentPool_instance.p2c(oldTail);
  }
}
class PeekSource {
  constructor(upstream) {
    this.r2c_1 = upstream;
    this.s2c_1 = this.r2c_1.q2a();
    this.t2c_1 = this.s2c_1.j2a_1;
    var tmp = this;
    var tmp0_safe_receiver = this.s2c_1.j2a_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.w2a_1;
    tmp.u2c_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.v2c_1 = false;
    this.w2c_1 = 0n;
  }
  r2b(sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.t2c_1 == null || (this.t2c_1 === this.s2c_1.j2a_1 && this.u2c_1 === ensureNotNull(this.s2c_1.j2a_1).w2a_1))) {
    ...
    if (!this.r2c_1.t2a(tmp$ret$7))
      return -1n;
    if (this.t2c_1 == null && !(this.s2c_1.j2a_1 == null)) {
      this.t2c_1 = this.s2c_1.j2a_1;
      this.u2c_1 = ensureNotNull(this.s2c_1.j2a_1).w2a_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.s2c_1.g2(), this.w2c_1);
    var toCopy = byteCount <= b ? byteCount : b;
    this.s2c_1.h2b(sink, this.w2c_1, add(this.w2c_1, toCopy));
    this.w2c_1 = add(this.w2c_1, toCopy);
    return toCopy;
  }
  a6() {
    this.v2c_1 = true;
...
class RealSource {
  ...
  r2b(sink, byteCount) {
    ...
    if (this.z2c_1.g2() === 0n) {
      var read = this.x2c_1.r2b(this.z2c_1, 8192n);
      if (read === -1n)
        return -1n;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.z2c_1.r2b(sink, toRead);
  }
  r2a() {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    return this.z2c_1.r2a() && this.x2c_1.r2b(this.z2c_1, 8192n) === -1n;
  }
  s2a(byteCount) {
    if (!this.t2a(byteCount))
      throw EOFException.p2a("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  }
  t2a(byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    while (this.z2c_1.g2() < byteCount) {
      if (this.x2c_1.r2b(this.z2c_1, 8192n) === -1n)
        return false;
    }
    return true;
  }
  ...
  p2b(sink, startIndex, endIndex) {
    ...
    return this.z2c_1.p2b(sink, startIndex, startIndex + toRead | 0);
  }
  t2b(sink, byteCount) {
    try {
      this.s2a(byteCount);
      ...
      if ($p instanceof EOFException) {
        var e = $p;
        sink.s2b(this.z2c_1, this.z2c_1.g2());
        throw e;
      } else {
        throw $p;
      }
    }
    this.z2c_1.t2b(sink, byteCount);
  }
  u2b(sink) {
    var totalBytesWritten = 0n;
    while (!(this.x2c_1.r2b(this.z2c_1, 8192n) === -1n)) {
      var emitByteCount = this.z2c_1.l2b();
      if (emitByteCount > 0n) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.s2b(this.z2c_1, emitByteCount);
      }
    }
    if (this.z2c_1.g2() > 0n) {
      totalBytesWritten = add(totalBytesWritten, this.z2c_1.g2());
      sink.s2b(this.z2c_1, this.z2c_1.g2());
    }
  ...
  toString() {
    return 'buffered(' + toString(this.x2c_1) + ')';
  }
}
class Companion {
  constructor() {
...
class Segment {
  f2c() {
    ...
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.e2d();
    return tmp1_elvis_lhs == null ? false : tmp1_elvis_lhs;
  }
  static d2d() {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.v2a_1 = new Int8Array(8192);
    $this.z2a_1 = true;
    $this.y2a_1 = null;
    return $this;
  }
  static f2d(data, pos, limit, shareToken, owner) {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.v2a_1 = data;
    $this.w2a_1 = pos;
    $this.x2a_1 = limit;
    $this.y2a_1 = shareToken;
    $this.z2a_1 = owner;
    return $this;
  }
  i2b() {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = SegmentPool_instance.g2d();
      this.y2a_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    ...
    var t = tmp;
    var tmp_0 = this.w2a_1;
    var tmp_1 = this.x2a_1;
    // Inline function 'kotlin.also' call
    t.h2d();
    return Segment.f2d(this.v2a_1, tmp_0, tmp_1, t, false);
  }
  i2c() {
    var result = this.a2b_1;
    if (!(this.b2b_1 == null)) {
      ensureNotNull(this.b2b_1).a2b_1 = this.a2b_1;
    }
    if (!(this.a2b_1 == null)) {
      ensureNotNull(this.a2b_1).b2b_1 = this.b2b_1;
    }
    this.a2b_1 = null;
    this.b2b_1 = null;
    return result;
  ...
  j2b(segment) {
    segment.b2b_1 = this;
    segment.a2b_1 = this.a2b_1;
    if (!(this.a2b_1 == null)) {
      ensureNotNull(this.a2b_1).b2b_1 = segment;
    }
    this.a2b_1 = segment;
    return segment;
  }
  g2c(byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.x2a_1 - this.w2a_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.z2b();
      var tmp0 = this.v2a_1;
      var tmp2 = prefix.v2a_1;
      var tmp5 = this.w2a_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.w2a_1 + byteCount | 0;
    ...
    prefix.x2a_1 = prefix.w2a_1 + byteCount | 0;
    this.w2a_1 = this.w2a_1 + byteCount | 0;
    if (!(this.b2b_1 == null)) {
      ensureNotNull(this.b2b_1).j2b(prefix);
    } else {
      prefix.a2b_1 = this;
      this.b2b_1 = prefix;
    }
  ...
  k2b() {
    ...
    if (!ensureNotNull(this.b2b_1).z2a_1)
      return this;
    var byteCount = this.x2a_1 - this.w2a_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.b2b_1).x2a_1 | 0) + (ensureNotNull(this.b2b_1).f2c() ? 0 : ensureNotNull(this.b2b_1).w2a_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.b2b_1;
    this.h2c(ensureNotNull(predecessor), byteCount);
    var successor = this.i2c();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException.o('Check failed.');
    }
    SegmentPool_instance.p2c(this);
    return predecessor;
  }
  l2c(byte) {
    var _unary__edvuaz = this.x2a_1;
    this.x2a_1 = _unary__edvuaz + 1 | 0;
    this.v2a_1[_unary__edvuaz] = byte;
  }
  n2c(short) {
    var data = this.v2a_1;
    var limit = this.x2a_1;
  ...
  d2b() {
    ...
    return this.v2a_1[_unary__edvuaz];
  }
  f2b() {
    var data = this.v2a_1;
    var pos = this.w2a_1;
  ...
  h2c(sink, byteCount) {
    ...
    if ((sink.x2a_1 + byteCount | 0) > 8192) {
      if (sink.f2c())
        throw IllegalArgumentException.dd();
      if (((sink.x2a_1 + byteCount | 0) - sink.w2a_1 | 0) > 8192)
        throw IllegalArgumentException.dd();
      var tmp0 = sink.v2a_1;
      var tmp2 = sink.v2a_1;
      var tmp5 = sink.w2a_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.x2a_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.x2a_1 = sink.x2a_1 - sink.w2a_1 | 0;
      sink.w2a_1 = 0;
    }
    var tmp0_0 = this.v2a_1;
    var tmp2_0 = sink.v2a_1;
    var tmp4 = sink.x2a_1;
    var tmp6 = this.w2a_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.w2a_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.x2a_1 = sink.x2a_1 + byteCount | 0;
    this.w2a_1 = this.w2a_1 + byteCount | 0;
  }
  q2b(dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.v2a_1;
    var tmp6 = this.w2a_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.w2a_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.w2a_1 = this.w2a_1 + len | 0;
  }
  c2c(src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.v2a_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.x2a_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.x2a_1 = this.x2a_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  }
  g2() {
    return this.x2a_1 - this.w2a_1 | 0;
  }
  b2c() {
    return this.v2a_1.length - this.x2a_1 | 0;
  }
  i2d(readOnly) {
    return this.v2a_1;
  }
  n2b(index) {
    return this.v2a_1[this.w2a_1 + index | 0];
  }
  j2d(index, value) {
    this.v2a_1[this.x2a_1 + index | 0] = value;
  }
  k2d(index, b0, b1) {
    var d = this.v2a_1;
    var l = this.x2a_1;
...
class SegmentReadContextImpl$1 {
  o2c(segment, offset) {
    return segment.n2b(offset);
  }
}
class SegmentWriteContextImpl$1 {
  q2d(segment, offset, value) {
    segment.j2d(offset, value);
  }
  p2d(segment, offset, b0, b1) {
    segment.k2d(offset, b0, b1);
  }
  o2d(segment, offset, b0, b1, b2) {
    segment.l2d(offset, b0, b1, b2);
  }
  n2d(segment, offset, b0, b1, b2, b3) {
    segment.m2d(offset, b0, b1, b2, b3);
  }
}
class BufferIterationContextImpl$1 {
  o2c(segment, offset) {
    return get_SegmentReadContextImpl().o2c(segment, offset);
  }
}
  ...
  $l$block_1: {
    ...
    if (subtract(_this__u8e3s4.g2(), startIndex) < startIndex) {
      ...
      do {
        ...
        segment_0 = segment_0.a2b_1;
      }
       while (!(segment_0 == null) && offset_1 < endOffset);
      return -1n;
    } else {
      var s_0 = _this__u8e3s4.j2a_1;
      var offset_2 = 0n;
      $l$loop_0: while (!(s_0 == null)) {
        var tmp0_4 = offset_2;
        // Inline function 'kotlin.Long.plus' call
        var other_1 = s_0.x2a_1 - s_0.w2a_1 | 0;
...
function readByteString(_this__u8e3s4, byteCount) {
  return UnsafeByteStringOperations_instance.i2a(readByteArray_0(_this__u8e3s4, byteCount));
}
...
function init_kotlinx_io_Segment(_this__u8e3s4) {
  _this__u8e3s4.w2a_1 = 0;
  _this__u8e3s4.x2a_1 = 0;
  _this__u8e3s4.y2a_1 = null;
  _this__u8e3s4.z2a_1 = false;
  _this__u8e3s4.a2b_1 = null;
  _this__u8e3s4.b2b_1 = null;
}
...
function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
  ...
  var p = _this__u8e3s4.w2a_1;
  var data = _this__u8e3s4.i2d(true);
...
function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
  ...
  $l$loop: while (true) {
    ...
    if (offset < endIndex) {
      ...
      tmp_0 = _this__u8e3s4.t2a(tmp$ret$2);
    } else {
      tmp_0 = false;
    }
    if (!tmp_0) {
    ...
    var tmp_1 = _this__u8e3s4.q2a();
    var tmp_2 = offset;
    // Inline function 'kotlin.comparisons.minOf' call
    var b = _this__u8e3s4.q2a().g2();
    var tmp$ret$3 = endIndex <= b ? endIndex : b;
    var idx = indexOf(tmp_1, byte, tmp_2, tmp$ret$3);
    if (!(idx === -1n)) {
      return idx;
    }
    offset = _this__u8e3s4.q2a().g2();
  }
  return -1n;
}
function readByteArrayImpl(_this__u8e3s4, size) {
  ...
  if (size === -1) {
    ...
    while (_this__u8e3s4.q2a().g2() < 2147483647n && _this__u8e3s4.t2a(fetchSize)) {
      // Inline function 'kotlin.Long.times' call
      var this_0 = fetchSize;
      fetchSize = multiply(this_0, fromInt(2));
    }
    // Inline function 'kotlin.check' call
    if (!(_this__u8e3s4.q2a().g2() < 2147483647n)) {
      var message = "Can't create an array of size " + _this__u8e3s4.q2a().g2().toString();
      throw IllegalStateException.o(toString(message));
    }
    arraySize = convertToInt(_this__u8e3s4.q2a().g2());
  } else {
    _this__u8e3s4.s2a(fromInt(size));
  }
  var array = new Int8Array(arraySize);
  readTo(_this__u8e3s4.q2a(), array);
  return array;
}
function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
  ...
  while (offset < endIndex) {
    var bytesRead = _this__u8e3s4.p2b(sink, offset, endIndex);
    if (bytesRead === -1) {
      throw EOFException.p2a('Source exhausted before reading ' + (endIndex - startIndex | 0) + ' bytes. ' + ('Only ' + bytesRead + ' bytes were read.'));
    }
    offset = offset + bytesRead | 0;
  }
}
function readString(_this__u8e3s4, byteCount) {
  _this__u8e3s4.s2a(byteCount);
  return commonReadUtf8(_this__u8e3s4.q2a(), byteCount);
}
function readString_0(_this__u8e3s4) {
  _this__u8e3s4.t2a(9223372036854775807n);
  return commonReadUtf8(_this__u8e3s4.q2a(), _this__u8e3s4.q2a().g2());
}
  ...
  while (i < endIndex) {
    ...
    if (c < 128) {
      $l$block_0: {
        ...
        ctx.q2d(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
        $l$loop: while (i < runLimit) {
          ...
          ctx.q2d(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
        }
        var bytesWritten = i + segmentOffset | 0;
        if (bytesWritten === 1) {
          tail.x2a_1 = tail.x2a_1 + bytesWritten | 0;
          var tmp = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_3 = this_0.l2a_1;
          tmp.l2a_1 = add(this_3, fromInt(bytesWritten));
          break $l$block_0;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten ? bytesWritten <= tail.b2c() : false)) {
          var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.b2c();
          throw IllegalStateException.o(toString(message));
        }
        if (!(bytesWritten === 0)) {
          tail.x2a_1 = tail.x2a_1 + bytesWritten | 0;
          var tmp_0 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_4 = this_0.l2a_1;
          tmp_0.l2a_1 = add(this_4, fromInt(bytesWritten));
          break $l$block_0;
        }
        if (isEmpty(tail)) {
          this_0.q2c();
      ...
      $l$block_2: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_0 = this_0.w2b(2);
        get_SegmentWriteContextImpl().p2d(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
        var bytesWritten_0 = 2;
        if (bytesWritten_0 === 2) {
          tail_0.x2a_1 = tail_0.x2a_1 + bytesWritten_0 | 0;
          var tmp_1 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_5 = this_0.l2a_1;
          tmp_1.l2a_1 = add(this_5, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.b2c() : false)) {
          var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.b2c();
        ...
        if (!(bytesWritten_0 === 0)) {
          ...
          var tmp_2 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_6 = this_0.l2a_1;
          tmp_2.l2a_1 = add(this_6, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        if (isEmpty(tail_0)) {
          this_0.q2c();
      ...
      $l$block_4: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_1 = this_0.w2b(3);
        get_SegmentWriteContextImpl().o2d(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
        var bytesWritten_1 = 3;
        if (bytesWritten_1 === 3) {
          tail_1.x2a_1 = tail_1.x2a_1 + bytesWritten_1 | 0;
          var tmp_3 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_7 = this_0.l2a_1;
          tmp_3.l2a_1 = add(this_7, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.b2c() : false)) {
          var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.b2c();
          throw IllegalStateException.o(toString(message_1));
        }
        if (!(bytesWritten_1 === 0)) {
          tail_1.x2a_1 = tail_1.x2a_1 + bytesWritten_1 | 0;
          var tmp_4 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_8 = this_0.l2a_1;
          tmp_4.l2a_1 = add(this_8, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        if (isEmpty(tail_1)) {
          this_0.q2c();
      ...
      if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
        ...
        this_0.k2c(toByte(tmp$ret$29));
        i = i + 1 | 0;
      } else {
        var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
        $l$block_6: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_2 = this_0.w2b(4);
          get_SegmentWriteContextImpl().n2d(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
          var bytesWritten_2 = 4;
          if (bytesWritten_2 === 4) {
            tail_2.x2a_1 = tail_2.x2a_1 + bytesWritten_2 | 0;
            var tmp_6 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_11 = this_0.l2a_1;
            tmp_6.l2a_1 = add(this_11, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.b2c() : false)) {
            var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.b2c();
          ...
          if (!(bytesWritten_2 === 0)) {
            ...
            var tmp_7 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_12 = this_0.l2a_1;
            tmp_7.l2a_1 = add(this_12, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          if (isEmpty(tail_2)) {
            this_0.q2c();
...
function init_kotlinx_io_IOException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.s2d_1);
}
function init_kotlinx_io_EOFException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.o2a_1);
}
...
protoOf(Buffer).d2c = write$default;
...
initMetadataForClass(IOException, 'IOException', IOException.t2d);
initMetadataForClass(EOFException, 'EOFException', EOFException.w2d);

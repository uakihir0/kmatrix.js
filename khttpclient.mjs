...
class HttpParameter {
  ...
  v3w() {
    var tmp0_safe_receiver = this.t3w_1;
  ...
  w3w() {
    switch (this.v3w()) {
      ...
      case 'jpg':
      case 'jpeg':
        return Image_getInstance().x2r_1;
      case 'png':
        return Image_getInstance().z2r_1;
      case 'gif':
        return Image_getInstance().u2r_1;
      case 'svg':
        return Image_getInstance().a2s_1;
      case 'mpeg':
        return Video_getInstance().z2s_1;
      case 'mp4':
        return Video_getInstance().a2t_1;
      case 'mov':
        return Video_getInstance().c2t_1;
      case 'webm':
        return ContentType.m2q('video', 'webm');
      case 'json':
        return Application_getInstance().u2q_1;
      case 'xml':
        return Application_getInstance().a2r_1;
      case 'zip':
        return Application_getInstance().d2r_1;
      case 'pdf':
        return Application_getInstance().g2r_1;
    }
    return Application_getInstance().x2q_1;
  }
}
class HttpRequest {
  constructor() {
    ...
    this.b3x_1 = null;
    this.c3x_1 = null;
    this.d3x_1 = 'kHttpClient/1.0';
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.e3x_1 = ArrayList.p2();
    var tmp_0 = this;
    // Inline function 'kotlin.collections.mutableMapOf' call
    tmp_0.f3x_1 = LinkedHashMap.y4();
    this.g3x_1 = false;
    this.h3x_1 = false;
    this.i3x_1 = true;
    this.j3x_1 = false;
  ...
  r3x(key, value) {
    ...
    this.f3x_1.z3(key, value);
    return this;
  }
  s3x(key, value) {
    // Inline function 'kotlin.also' call
    this.e3x_1.d2(Companion_instance.n3w(key, toString(value)));
    return this;
  }
  o3w(key, fileName, fileBody) {
    // Inline function 'kotlin.also' call
    this.e3x_1.d2(Companion_instance.o3w(key, fileName, fileBody));
    return this;
  }
  p3w(json) {
    // Inline function 'kotlin.also' call
    this.e3x_1.d2(Companion_instance.p3w(json));
    return this;
  }
  *t3x($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().i2y_1, $completion);
  }
  *u3x($completion) {
    return yield* /*#__NOINLINE__*/proceed(this, Companion_getInstance_1().j2y_1, $completion);
  }
  *v3x($completion) {
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.n3x_1 = Json(VOID, HttpResponse$Companion$mapper$lambda);
  }
  *o3x(response, $completion) {
    var tmp = response.q3g().f31_1;
    var tmp_0 = toMap(response.h2y());
    ...
    var tmp_5 = yield* tmp_1.e3g(tmp$ret$1, $completion);
...
class HttpResponse {
  constructor(status, headers, body) {
    ...
    this.z3x_1 = body;
    var tmp = this;
    tmp.a3y_1 = lazy(HttpResponse$stringBody$delegate$lambda(this));
  }
  b3y() {
    var tmp0 = this.a3y_1;
    var tmp = KProperty1;
  ...
  $l$block_0: {
    ...
    try {
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.collections.set' call
        $this.f3x_1.z3('Accept', tmp0_safe_receiver);
      }
      var tmp1_safe_receiver = $this.d3x_1;
      if (tmp1_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        var tmp0_0 = $this.f3x_1;
        // Inline function 'kotlin.collections.set' call
        var key = 'User-Agent';
      ...
      if (!(req.b3x_1 == null)) {
        ...
        takeFrom(this_0.i3f_1, URLBuilder(tmp_0));
      } else {
        url(this_0, req.x3w_1, req.y3w_1, req.a3x_1, req.z3w_1);
      }
      headers(this_0, HttpRequest$proceed$lambda_0(req));
      timeout(this_0, HttpRequest$proceed$lambda_1(req));
      if (!$this.g3x_1 && !$this.h3x_1 && req.e3x_1.g2() === 1 && canSendOnly($this, first(req.e3x_1))) {
        var param = first(req.e3x_1);
        // Inline function 'io.ktor.client.request.setBody' call
        var body = new ByteArrayContent(ensureNotNull(param.u3w_1), param.w3w());
        if (body == null) {
          this_0.l3f_1 = NullBody_instance;
          // Inline function 'io.ktor.util.reflect.typeInfo' call
          ...
          if (body instanceof OutgoingContent) {
            ...
            this_0.c3j(tmp$ret$17);
          }
        }
      } else {
        if (method.equals(Companion_getInstance_1().i2y_1)) {
          // Inline function 'kotlin.collections.forEach' call
          var _iterator__ex2g4s = req.e3x_1.l1();
          while (_iterator__ex2g4s.m1()) {
            var element = _iterator__ex2g4s.n1();
            if (element.q3w_1.s1_1 === 0) {
              this_0.i3f_1.u31_1.i2l(element.r3w_1, ensureNotNull(element.s3w_1));
            } else {
          ...
          while (_iterator__ex2g4s_1.m1()) {
            ...
            if (element_1.q3w_1.equals(Type_PARAM_getInstance())) {
              destination_0.d2(element_1);
            }
          }
          var params = destination_0;
          // Inline function 'kotlin.collections.filter' call
          var tmp0_4 = req.e3x_1;
          // Inline function 'kotlin.collections.filterTo' call
          ...
          while (_iterator__ex2g4s_2.m1()) {
            ...
            if (element_2.q3w_1.equals(Type_FILE_getInstance())) {
          ...
          if (!queries.j1()) {
            ...
            while (_iterator__ex2g4s_3.m1()) {
              ...
              this_0.i3f_1.u31_1.i2l(element_3.r3w_1, ensureNotNull(element_3.s3w_1));
            }
          }
          var tmp_7;
          // Inline function 'kotlin.collections.isNotEmpty' call
          ...
          if (tmp_7) {
            if ($this.h3x_1) {
              ...
              contentType(this_0, Application_getInstance().f2r_1);
              ...
              while (_iterator__ex2g4s_4.m1()) {
                ...
                this_1.i2l(element_4.r3w_1, ensureNotNull(element_4.s3w_1));
              }
              var tmp$ret$36 = this_1.k2t();
              // Inline function 'io.ktor.client.request.setBody' call
              ...
              if (body_0 == null) {
                ...
                if (body_0 instanceof OutgoingContent) {
                  ...
                  this_0.c3j(tmp$ret$44);
                }
              }
            } else {
              contentType(this_0, MultiPart_getInstance().j2s_1);
              ...
              while (_iterator__ex2g4s_5.m1()) {
                ...
                this_2.p3t(element_5.r3w_1, ensureNotNull(element_5.s3w_1));
              }
              // Inline function 'kotlin.collections.forEach' call
              var _iterator__ex2g4s_6 = files.l1();
              while (_iterator__ex2g4s_6.m1()) {
                var element_6 = _iterator__ex2g4s_6.n1();
                var tmp_14 = ensureNotNull(element_6.u3w_1);
                // Inline function 'io.ktor.http.Companion.build' call
                Companion_getInstance();
                // Inline function 'kotlin.apply' call
                var this_3 = new HeadersBuilder();
                append(this_3, 'Content-Type', element_6.w3w());
                this_3.i2l('Content-Disposition', 'filename=' + element_6.t3w_1);
                var tmp$ret$53 = this_3.k2t();
                this_2.q3t(element_6.r3w_1, tmp_14, tmp$ret$53);
              }
              // Inline function 'kotlin.collections.toTypedArray' call
              var this_4 = this_2.r3t();
      ...
      // Inline function 'io.ktor.client.request.request' call
      var tmp$ret$8 = yield* (new HttpStatement(this_0, tmp0)).a3v($completion);
      tmp$ret$0 = yield* tmp.o3x(tmp$ret$8, $completion);
      break $l$block_0;
    } catch ($p_5) {
...
function canSendOnly($this, param) {
  if (param.q3w_1.equals(Type_JSON_getInstance()))
    return true;
  var tmp0_subject = param.w3w();
  return tmp0_subject.equals(Application_getInstance().u2q_1) ? true : tmp0_subject.equals(Image_getInstance().x2r_1) ? true : tmp0_subject.equals(Image_getInstance().z2r_1) ? true : tmp0_subject.equals(Image_getInstance().u2r_1) ? true : tmp0_subject.equals(Video_getInstance().z2s_1) ? true : tmp0_subject.equals(Video_getInstance().a2t_1) ? true : tmp0_subject.equals(Video_getInstance().c2t_1) ? true : tmp0_subject.equals(ContentType.m2q('video', 'webm')) ? true : false;
}
function HttpRequest$proceed$lambda($req) {
  return ($this$HttpClient) => {
    ...
    $this$HttpClient.u3e_1 = $req.i3x_1;
    return Unit_instance;
  };
}
function HttpRequest$proceed$lambda_0($req) {
  return ($this$headers) => {
    ...
    var _iterator__ex2g4s = $req.f3x_1.u2().l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
...
function HttpRequest$proceed$lambda_1($req) {
  return ($this$timeout) => {
    $this$timeout.x3o($req.k3x_1);
    $this$timeout.y3o($req.l3x_1);

...
class Companion {
  constructor() {
    ...
    this.b2e_1 = new Closed(null);
    var tmp = this;
    // Inline function 'kotlin.Companion.success' call
    tmp.c2e_1 = _Result___init__impl__xyqfz8(Unit_instance);
  }
}
class Empty {
  toString() {
...
class Closed {
  ...
  toString() {
    return 'Closed(cause=' + toString(this.d2e_1) + ')';
  }
  hashCode() {
    return this.d2e_1 == null ? 0 : hashCode(this.d2e_1);
  }
  equals(other) {
    if (this === other)
      return true;
...
class Task {}
function resume() {
  return this.f2e().zb(Companion_getInstance().c2e_1);
}
function resume_0(throwable) {
  ...
  return tmp.zb(tmp1_elvis_lhs == null ? Companion_getInstance().c2e_1 : tmp1_elvis_lhs.hq_1);
}
class Read {
  constructor(continuation) {
    this.j2e_1 = continuation;
    this.k2e_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('ReadTask 0x' + toString_0(hashCode(this.j2e_1), 16));
...
class Write {
  constructor(continuation) {
    this.l2e_1 = continuation;
    this.m2e_1 = null;
    if (get_DEVELOPMENT_MODE()) {
      var tmp = this;
      // Inline function 'kotlin.also' call
      var this_0 = newThrowable('WriteTask 0x' + toString_0(hashCode(this.l2e_1), 16));
      stackTraceToString(this_0);
      tmp.m2e_1 = this_0;
    }
  }
...
function awaitContent$default(min, $completion, $super) {
  min = min === VOID ? 1 : min;
  return $super === VOID ? this.s2f(min, $completion) : $super.s2f.call(this, min, $completion);
}
...
class ByteChannel {
  constructor(autoFlush) {
    ...
    this.n2e_1 = autoFlush;
    this.o2e_1 = new Buffer();
    this.p2e_1 = 0;
    this.q2e_1 = new Object();
    this.r2e_1 = atomic$ref$1(Empty_instance);
    this.s2e_1 = new Buffer();
    this.t2e_1 = new Buffer();
    this.u2e_1 = atomic$ref$1(null);
    this.v2e_1 = atomic$ref$1(null);
  }
  x2e() {
    return this.n2e_1;
  }
  y2e() {
    return this.p2e_1 < 1048576;
  }
  z2e() {
    var tmp0_safe_receiver = this.u2e_1.kotlinx$atomicfu$value;
    if (tmp0_safe_receiver == null)
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(tmp0_safe_receiver).hz();
        } else {
          if (tmp0_subject instanceof CancellationException) {
            ...
            tmp = ClosedReadChannelException.e2f(p0);
          }
        }
      }
    ...
    if (this.l2f()) {
      ...
      if (tmp0_safe_receiver == null) {
        ...
        if (tmp0_subject == null) {
          ...
          if (isInterface(tmp0_subject, CopyableThrowable)) {
            tmp_0 = access$_get_origin__hdh1qz(tmp0_safe_receiver).hz();
          } else {
            if (tmp0_subject instanceof CancellationException) {
              ...
              var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
              tmp_0 = ClosedWriteChannelException.k2f(p0);
            }
          }
        }
      ...
      if (tmp == null)
        throw ClosedWriteChannelException.k2f();
    }
    return this.t2e_1;
  }
  m2f() {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          ...
          if (tmp0_subject instanceof CancellationException) {
            ...
            var p0 = access$_get_origin__hdh1qz(tmp0_safe_receiver);
            tmp_0 = ClosedByteChannelException.q2f(p0);
          }
        }
      }
      tmp = tmp_0;
  ...
  l2f() {
    return !(this.u2e_1.kotlinx$atomicfu$value == null);
  }
  r2f() {
    return !(this.m2f() == null) || (this.l2f() && this.p2e_1 === 0 && this.s2e_1.v2a());
  }
  *s2f(min, $completion) {
    rethrowCloseCauseIfNeeded_0(this);
    if (this.s2e_1.g2() >= fromInt(min))
      return true;
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (add(numberToLong(this.p2e_1), this.s2e_1.g2()) < fromInt(min) && this.u2e_1.kotlinx$atomicfu$value == null) {
      ...
      (yield () => {
        ...
        $l$block_0: {
          ...
          var previous = tmp0.r2e_1.kotlinx$atomicfu$value;
          if (!(previous instanceof Closed)) {
            if (!tmp0.r2e_1.atomicfu$compareAndSet(previous, tmp2)) {
              tmp2.h2e();
              break $l$block_0;
            }
          }
          if (previous instanceof Read) {
            previous.i2e(ConcurrentIOException.x2f(tmp2.g2e(), previous.e2e()));
          } else {
            if (isInterface(previous, Task)) {
              previous.h2e();
            } else {
              if (previous instanceof Closed) {
                tmp2.i2e(previous.d2e_1);
                break $l$block_0;
              } else {
          ...
          if (!(add(numberToLong(this.p2e_1), this.s2e_1.g2()) < fromInt(min) && this.u2e_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.r2e_1.kotlinx$atomicfu$value;
            var tmp;
            if (current instanceof Read) {
              tmp = tmp0.r2e_1.atomicfu$compareAndSet(current, Empty_instance);
            } else {
              tmp = false;
            }
            if (tmp) {
        ...
        return cancellable.jx();
      });
    }
    if (this.s2e_1.g2() < 1048576n) {
      moveFlushToReadBuffer(this);
    }
    return this.s2e_1.g2() >= fromInt(min);
  }
  *z2f($completion) {
    rethrowCloseCauseIfNeeded_0(this);
    this.a2g();
    ...
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (!this.y2e() && this.u2e_1.kotlinx$atomicfu$value == null) {
      // Inline function 'kotlinx.coroutines.suspendCancellableCoroutine' call
      // Inline function 'kotlin.js.suspendCoroutineUninterceptedOrReturnJS' call
      (yield () => {
        var uCont = $completion;
        ...
        $l$block_0: {
          ...
          if (!(!this.y2e() && this.u2e_1.kotlinx$atomicfu$value == null)) {
            // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
            var current = tmp0.r2e_1.kotlinx$atomicfu$value;
            var tmp;
  ...
  a2g() {
    ...
    this.q2e_1;
    var count = convertToInt(this.t2e_1.g2());
    this.o2e_1.n2c(this.t2e_1);
    this.p2e_1 = this.p2e_1 + count | 0;
    // Inline function 'io.ktor.utils.io.ByteChannel.resumeSlot' call
    var current = this.r2e_1.kotlinx$atomicfu$value;
    var tmp;
    if (current instanceof Read) {
      tmp = this.r2e_1.atomicfu$compareAndSet(current, Empty_instance);
    } else {
      tmp = false;
    }
    if (tmp) {
  ...
  a6() {
    this.a2g();
    if (!this.u2e_1.atomicfu$compareAndSet(null, get_CLOSED()))
      return Unit_instance;
    closeSlot(this, null);
  }
  *b2g($completion) {
  ...
  c2g(cause) {
    if (!(this.u2e_1.kotlinx$atomicfu$value == null))
      return Unit_instance;
    var closedToken = new CloseToken(cause);
    this.u2e_1.atomicfu$compareAndSet(null, closedToken);
    // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
    ...
    if (tmp0_subject == null) {
      ...
      if (isInterface(tmp0_subject, CopyableThrowable)) {
        tmp = access$_get_origin__hdh1qz(closedToken).hz();
      } else {
        if (tmp0_subject instanceof CancellationException) {
          ...
          tmp = ClosedByteChannelException.q2f(p0);
        }
      }
    }
  ...
  d2g(handler) {
    var existingCause = this.u2e_1.kotlinx$atomicfu$value;
    if (!(existingCause == null)) {
      ...
      if (tmp0_subject == null) {
        ...
        if (isInterface(tmp0_subject, CopyableThrowable)) {
          tmp = access$_get_origin__hdh1qz(existingCause).hz();
        } else {
          if (tmp0_subject instanceof CancellationException) {
    ...
    if (!this.v2e_1.atomicfu$compareAndSet(null, handler)) {
    ...
    var cause = this.u2e_1.kotlinx$atomicfu$value;
    if (!(cause == null) && this.v2e_1.atomicfu$compareAndSet(handler, null)) {
      // Inline function 'io.ktor.utils.io.Companion.wrapCause' call
      ...
      if (tmp0_subject_0 == null) {
        ...
        if (isInterface(tmp0_subject_0, CopyableThrowable)) {
          tmp_1 = access$_get_origin__hdh1qz(cause).hz();
        } else {
          if (tmp0_subject_0 instanceof CancellationException) {
            ...
            tmp_1 = ClosedByteChannelException.q2f(p0_0);
          }
        }
      }
      handler(tmp_1);
...
class ByteChannelScanner {
  constructor(channel, matchString, writeChannel, limit) {
    ...
    this.e2g_1 = channel;
    this.f2g_1 = matchString;
    this.g2g_1 = writeChannel;
    this.h2g_1 = limit;
    ...
    this.i2g_1 = this.e2g_1.z2e();
    this.j2g_1 = buildPartialMatchTable(this);
    this.k2g_1 = new Buffer();
    this.l2g_1 = 0n;
    this.m2g_1 = 0;
  }
  *n2g(ignoreMissing, $completion) {
    this.l2g_1 = 0n;
    while (!this.i2g_1.v2a() || (yield* this.e2g_1.y2f(VOID, $completion))) {
    ...
    if (!ignoreMissing) {
      throw IOException.y2d('Expected "' + toSingleLineString(this, this.f2g_1) + '" but encountered end of input');
    }
    this.l2g_1 = add(this.l2g_1, this.k2g_1.y2b(this.g2g_1.f2f()));
    yield* this.g2g_1.z2f($completion);
    return this.l2g_1;
  }
}
...
class Companion_0 {
  constructor() {
    ...
    var tmp = this;
    tmp.s2g_1 = new ByteReadChannel$Companion$Empty$1();
  }
}
class WriterJob {
...
class NO_CALLBACK$1 {
  constructor() {
    this.a2h_1 = EmptyCoroutineContext_instance;
  }
  xb() {
    return this.a2h_1;
  }
...
class ByteWriteChannel$flushAndClose$ref {
  ...
  *c2h($completion) {
    return yield* this.b2h_1.b2g($completion);
  }
  vc($completion) {
...
class writer$slambda {
  ...
  *f2h($this$launch, $completion) {
    var nested = Job(get_job($this$launch.rs()));
    try {
      yield* this.d2h_1(new WriterScope(this.e2h_1, $this$launch.rs().nj(nested)), $completion);
      nested.wy();
      if (get_job($this$launch.rs()).ot()) {
        this.e2h_1.c2g(get_job($this$launch.rs()).rt());
      }
    } catch ($p) {
      if ($p instanceof Error) {
        var cause = $p;
        cancel(nested, 'Exception thrown while writing to channel', cause);
        this.e2h_1.c2g(cause);
      } else {
        throw $p;
      }
    }
    finally {
      yield* nested.yt($completion);
      // Inline function 'kotlin.runCatching' call
      var tmp;
      try {
        yield* this.e2h_1.b2g($completion);
        // Inline function 'kotlin.Companion.success' call
        tmp = _Result___init__impl__xyqfz8(Unit_instance);
      } catch ($p) {
        var tmp_0;
  ...
  wc(p1, $completion) {
    return this.f2h((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
  }
}
class Companion_1 {}
class CloseToken {
...
class CountedByteReadChannel {
  ...
  m2f() {
    return this.h2h_1.m2f();
  }
  r2f() {
    return this.i2h_1.v2a() && this.h2h_1.r2f();
  }
  z2e() {
  ...
  *s2f(min, $completion) {
    if (this.z2e().g2() >= fromInt(min)) {
      return true;
    }
    if (yield* this.h2h_1.s2f(min, $completion)) {
      transferFromDelegate(this);
      return true;
    }
    return false;
...
class ClosedByteChannelException extends IOException {
  static q2f(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.z2d(cause == null ? null : cause.message, cause);
    captureStack($this, $this.p2f_1);
    return $this;
  }
}
class ClosedReadChannelException extends ClosedByteChannelException {
  static e2f(cause) {
    cause = cause === VOID ? null : cause;
    var $this = this.q2f(cause);
    captureStack($this, $this.d2f_1);
    return $this;
  }
}
...
class Companion_2 {
  constructor() {
    ...
    this.m2h_1 = _LineEndingMode___init__impl__jo5bul(1);
    this.n2h_1 = _LineEndingMode___init__impl__jo5bul(2);
    this.o2h_1 = _LineEndingMode___init__impl__jo5bul(4);
    this.p2h_1 = _LineEndingMode___init__impl__jo5bul(7);
    this.q2h_1 = listOf([new LineEndingMode(this.m2h_1), new LineEndingMode(this.n2h_1), new LineEndingMode(this.o2h_1)]);
  }
}
class LineEndingMode {
  ...
  toString() {
    return LineEndingMode__toString_impl_j4h76r(this.r2h_1);
  }
  hashCode() {
    return LineEndingMode__hashCode_impl_2mopm4(this.r2h_1);
  }
  equals(other) {
    return LineEndingMode__equals_impl_qyr4nk(this.r2h_1, other);
  }
}
class SourceByteReadChannel {
  ...
  m2f() {
    var tmp0_safe_receiver = this.t2h_1;
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  *s2f(min, $completion) {
    ...
    return this.s2h_1.x2a(fromInt(min));
  }
  c2g(cause) {
    if (!(this.t2h_1 == null))
      return Unit_instance;
    ...
    tmp.t2h_1 = new CloseToken(IOException.z2d(tmp1_elvis_lhs == null ? 'Channel was cancelled' : tmp1_elvis_lhs, cause));
  }
}
class MalformedInputException extends IOException {
  static x2h(message) {
    var $this = this.y2d(message);
    captureStack($this, $this.w2h_1);
    return $this;
  }
}
class TooLongLineException extends MalformedInputException {
  static x2g(message) {
    var $this = this.x2h(message);
    captureStack($this, $this.w2g_1);
    return $this;
  }
}
class ObjectPool {}
...
class DefaultPool {
  ...
  n2i() {
    ...
    var idx = this.j2i_1;
    var tmp = this.i2i_1[idx];
    var instance = !(tmp == null) ? tmp : THROW_CCE();
    this.i2i_1[idx] = null;
    return this.l2i(instance);
  }
  o2i(instance) {
    this.m2i(instance);
    if (this.j2i_1 === this.h2i_1) {
      this.k2i(instance);
    } else {
      var _unary__edvuaz = this.j2i_1;
      this.j2i_1 = _unary__edvuaz + 1 | 0;
      this.i2i_1[_unary__edvuaz] = instance;
    }
  }
  uv() {
...
class Companion_3 {
  p2i(name) {
    switch (name) {
      ...
      case 'UTF8':
      case 'utf8':
        return Charsets_getInstance().y2h_1;
    }
    var tmp;
    var tmp_0;
    switch (name) {
    ...
    if (tmp) {
      return Charsets_getInstance().z2h_1;
    }
...
class Charsets {
  constructor() {
    ...
    this.y2h_1 = new CharsetImpl('UTF-8');
    this.z2h_1 = new CharsetImpl('ISO-8859-1');
  }
}
...
class CharsetEncoderImpl extends CharsetEncoder {
  ...
  toString() {
    return 'CharsetEncoderImpl(charset=' + this.w2i_1.toString() + ')';
  }
  hashCode() {
    return this.w2i_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof CharsetEncoderImpl))
      return false;
    if (!this.w2i_1.equals(other.w2i_1))
      return false;
    return true;
  }
}
class CharsetDecoderImpl extends CharsetDecoder {
  ...
  toString() {
    return 'CharsetDecoderImpl(charset=' + this.y2i_1.toString() + ')';
  }
  hashCode() {
    return this.y2i_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof CharsetDecoderImpl))
      return false;
    if (!this.y2i_1.equals(other.y2i_1))
      return false;
    return true;
  }
}
class toKtor$1 {
  constructor($this_toKtor) {
    this.z2i_1 = $this_toKtor;
  }
  t2i(buffer) {
    return this.z2i_1.decode(buffer);
  }
}
  ...
  t2i(buffer) {
    ...
    if (inductionVariable < last)
      $l$loop: do {
        ...
        if (point > 255) {
          builder.o2c(toByte(point >> 8));
        }
        builder.o2c(toByte(point & 255));
      }
       while (inductionVariable < last);
...
function closeSlot($this, cause) {
  var closeContinuation = !(cause == null) ? new Closed(cause) : Companion_getInstance().b2e_1;
  var continuation = $this.r2e_1.atomicfu$getAndSet(closeContinuation);
  if (isInterface(continuation, Task)) {
    continuation.i2e(cause);
  }
  var tmp0_safe_receiver = $this.v2e_1.atomicfu$getAndSet(null);
  if (tmp0_safe_receiver == null)
    null;
  else
...
function ByteChannel$invokeOnClose$lambda_1(this$0, $handler) {
  return () => {
    this$0.v2e_1.atomicfu$compareAndSet($handler, null);
    return Unit_instance;
  };
}
function ByteReadChannel_0(content, offset, length) {
  ...
  this_0.e2c(content, offset, offset + length | 0);
  var source = this_0;
...
function buildPartialMatchTable($this) {
  var table = new Int32Array($this.f2g_1.g2());
  var j = 0;
  var inductionVariable = 1;
  var last = $this.f2g_1.g2();
  if (inductionVariable < last)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
      while (j > 0 && !($this.f2g_1.f2(i) === $this.f2g_1.f2(j))) {
        j = table[j - 1 | 0];
      }
      if ($this.f2g_1.f2(i) === $this.f2g_1.f2(j)) {
        j = j + 1 | 0;
      }
      table[i] = j;
    }
...
function *advanceToNextPotentialMatch($this, $completion) {
  while (!$this.i2g_1.v2a() || (yield* $this.e2g_1.y2f(VOID, $completion))) {
    var nextMatch = indexOf($this.i2g_1, $this.f2g_1.f2(0));
    if (nextMatch === -1n) {
      var tmp = $this.i2g_1;
      checkBounds($this, (tmp instanceof Buffer ? tmp : THROW_CCE()).g2());
      $this.l2g_1 = add($this.l2g_1, $this.i2g_1.y2b($this.g2g_1.f2f()));
      yield* flushIfNeeded($this.g2g_1, $completion);
    } else {
      checkBounds($this, nextMatch);
      var tmp_0 = $this;
      var tmp_1 = $this.l2g_1;
      var tmp_2 = $this.g2g_1.f2f();
      tmp_0.l2g_1 = add(tmp_1, $this.i2g_1.v2b(tmp_2 instanceof Buffer ? tmp_2 : THROW_CCE(), nextMatch));
      yield* flushIfNeeded($this.g2g_1, $completion);
      return Unit_instance;
    }
  }
...
function *checkFullMatch($this, $completion) {
  while (!$this.i2g_1.v2a() || (yield* $this.e2g_1.y2f(VOID, $completion))) {
    var byte = $this.i2g_1.y2a();
    if ($this.m2g_1 > 0 && !(byte === $this.f2g_1.f2($this.m2g_1))) {
      var oldMatchIndex = $this.m2g_1;
      while ($this.m2g_1 > 0 && !(byte === $this.f2g_1.f2($this.m2g_1))) {
        $this.m2g_1 = $this.j2g_1[$this.m2g_1 - 1 | 0];
      }
      var retained = fromInt(oldMatchIndex - $this.m2g_1 | 0);
      checkBounds($this, retained);
      var tmp = $this;
      var tmp_0 = $this.l2g_1;
      var tmp_1 = $this.g2g_1.f2f();
      tmp.l2g_1 = add(tmp_0, $this.k2g_1.v2b(tmp_1 instanceof Buffer ? tmp_1 : THROW_CCE(), retained));
      if ($this.m2g_1 === 0 && !(byte === $this.f2g_1.f2($this.m2g_1))) {
        yield* writeByte($this.g2g_1, byte, $completion);
        var _unary__edvuaz = $this.l2g_1;
        $this.l2g_1 = add(_unary__edvuaz, get_ONE());
        return false;
      }
    }
    $this.m2g_1 = $this.m2g_1 + 1 | 0;
    if ($this.m2g_1 === $this.f2g_1.g2()) {
      return true;
    }
    $this.k2g_1.o2c(byte);
  }
...
function checkBounds($this, extra) {
  if (add($this.l2g_1, extra) > $this.h2g_1) {
    throw IOException.y2d('Limit of ' + $this.h2g_1.toString() + ' bytes exceeded ' + ('while searching for "' + toSingleLineString($this, $this.f2g_1) + '"'));
  }
}
...
function attachWriterJob(_this__u8e3s4, writerJob) {
  var tmp = writerJob.o2g_1;
  var tmp0_safe_receiver = tmp instanceof ByteChannel ? tmp : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.d2g(attachWriterJob$lambda(_this__u8e3s4));
  }
}
function attachWriterJob$lambda($this_attachWriterJob) {
  return (cause) => {
    var tmp;
    if (!(cause == null)) {
      $this_attachWriterJob.c2g(cause);
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function cancel_0(_this__u8e3s4) {
  _this__u8e3s4.c2g(IOException.y2d('Channel was cancelled'));
}
function *readRemaining(_this__u8e3s4, $completion) {
  var result = BytePacketBuilder();
  while (!_this__u8e3s4.r2f()) {
    result.n2c(_this__u8e3s4.z2e());
    yield* _this__u8e3s4.y2f(VOID, $completion);
  }
...
function *copyTo(_this__u8e3s4, channel, limit, $completion) {
  var remaining = limit;
  try {
    while (!_this__u8e3s4.r2f() && remaining > 0n) {
      if (_this__u8e3s4.z2e().v2a()) {
        yield* _this__u8e3s4.y2f(VOID, $completion);
      }
      var tmp0 = remaining;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = get_remaining(_this__u8e3s4.z2e());
      var count = tmp0 <= b ? tmp0 : b;
      _this__u8e3s4.z2e().x2b(channel.f2f(), count);
      remaining = subtract(remaining, count);
      yield* channel.z2f($completion);
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var cause = $p;
      _this__u8e3s4.c2g(cause);
...
function rethrowCloseCauseIfNeeded(_this__u8e3s4) {
  var tmp0_safe_receiver = _this__u8e3s4.m2f();
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
...
function *discard(_this__u8e3s4, max, $completion) {
  ...
  var remaining = max;
  while (remaining > 0n && !_this__u8e3s4.r2f()) {
    ...
    var b = get_remaining(_this__u8e3s4.z2e());
    var count = tmp0 <= b ? tmp0 : b;
    discard_0(_this__u8e3s4.z2e(), count);
    remaining = subtract(remaining, count);
  }
...
function *copyTo_0(_this__u8e3s4, channel, $completion) {
  ...
  try {
    while (!_this__u8e3s4.r2f()) {
      result = add(result, _this__u8e3s4.z2e().y2b(channel.f2f()));
      yield* channel.z2f($completion);
      yield* _this__u8e3s4.y2f(VOID, $completion);
    }
  } catch ($p) {
...
function *readAvailable(_this__u8e3s4, buffer, offset, length, $completion) {
  ...
  if (_this__u8e3s4.r2f())
    return -1;
  return readAvailable_0(_this__u8e3s4.z2e(), buffer, offset, length);
}
...
function *readPacket(_this__u8e3s4, packet, $completion) {
  ...
  $l$loop: while (result.g2() < fromInt(packet)) {
    ...
    if (_this__u8e3s4.r2f())
      break $l$loop;
    if (get_remaining(_this__u8e3s4.z2e()) > subtract(numberToLong(packet), result.g2())) {
      _this__u8e3s4.z2e().x2b(result, subtract(numberToLong(packet), result.g2()));
    } else {
      _this__u8e3s4.z2e().y2b(result);
    }
  }
  if (result.g2() < fromInt(packet)) {
    throw EOFException.t2a('Not enough data available, required ' + packet + ' bytes but only ' + result.g2().toString() + ' available');
  }
  return result;
}
function *readUntil(_this__u8e3s4, matchString, writeChannel, limit, ignoreMissing, $completion) {
  ...
  return yield* (new ByteChannelScanner(_this__u8e3s4, matchString, writeChannel, limit)).n2g(ignoreMissing, $completion);
}
...
function get_availableForRead(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.z2e().u2a().g2());
}
function *peek(_this__u8e3s4, count, $completion) {
  if (_this__u8e3s4.r2f())
    return null;
  if (!(yield* _this__u8e3s4.s2f(count, $completion)))
    return null;
  return readByteString(_this__u8e3s4.z2e().z2b(), count);
}
function *internalReadLineTo(_this__u8e3s4, out, limit, lenientLineEnding, throwOnIncompleteLine, $completion) {
  var readBuffer = _this__u8e3s4.z2e();
  if (readBuffer.v2a()) {
    yield* _this__u8e3s4.y2f(VOID, $completion);
  }
  if (_this__u8e3s4.r2f())
    return -1n;
  var consumed = {_v: 0n};
  $l$loop: while (consumed._v < limit && !_this__u8e3s4.r2f()) {
    ...
    if (lfIndex > 0n) {
      var tmp;
      var tmp_0 = readBuffer.u2a();
      // Inline function 'kotlin.Long.minus' call
      var tmp$ret$0 = subtract(lfIndex, fromInt(1));
      if (tmp_0.q2b(tmp$ret$0) === 13) {
        tmp = 1n;
      } else {
        tmp = 0n;
      }
    ...
    var tmp_1 = readBuffer.u2a();
    // Inline function 'kotlin.Long.minus' call
    var tmp$ret$2 = subtract(count, fromInt(1));
    if (tmp_1.q2b(tmp$ret$2) === 13) {
      // Inline function 'kotlin.Long.minus' call
    ...
    if (consumed._v < limit && get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.y2f(VOID, $completion)))
      break $l$loop;
  }
  if (consumed._v === 0n && _this__u8e3s4.r2f())
    return -1n;
  // Inline function 'kotlin.check' call
  ...
  if (consumed._v === limit) {
    if (limit === 9223372036854775807n)
      throw TooLongLineException.x2g('Max line length exceeded');
    if (get_remaining(readBuffer) === 0n && !(yield* _this__u8e3s4.y2f(VOID, $completion))) {
      throwEndOfStreamException(consumed._v);
    }
    var tmp0_subject = readBuffer.u2a().q2b(0n);
    if (tmp0_subject === 10) {
      discard_0(readBuffer, 1n);
      return consumed._v;
...
function throwEndOfStreamException(consumed) {
  throw EOFException.t2a('Unexpected end of stream after reading ' + consumed.toString() + ' characters');
}
function throwTooLongLineException(limit) {
  throw TooLongLineException.x2g('Line exceeds limit of ' + limit.toString() + ' characters');
}
...
function *internalReadLineTo$discardCrlfOrCr(_this__u8e3s4, $this_internalReadLineTo, $lenientLineEnding, $completion) {
  if ((get_remaining(_this__u8e3s4) >= 2n || (yield* $this_internalReadLineTo.s2f(2, $completion))) && _this__u8e3s4.u2a().q2b(1n) === 10) {
...
function *flushIfNeeded(_this__u8e3s4, $completion) {
  ...
  if (_this__u8e3s4.x2e() || get_size(_this__u8e3s4.f2f()) >= 1048576)
    yield* _this__u8e3s4.z2f($completion);
  return Unit_instance;
}
...
function invokeOnCompletion(_this__u8e3s4, block) {
  _init_properties_ByteWriteChannelOperations_kt__i7slrs();
  return _this__u8e3s4.ky().ut(block);
}
function *writeFully(_this__u8e3s4, value, startIndex, endIndex, $completion) {
  startIndex = startIndex === VOID ? 0 : startIndex;
  endIndex = endIndex === VOID ? value.length : endIndex;
  _this__u8e3s4.f2f().e2c(value, startIndex, endIndex);
...
function *writePacket(_this__u8e3s4, source, $completion) {
  while (!source.v2a()) {
    _this__u8e3s4.f2f().i2c(source, get_remaining(source));
    yield* flushIfNeeded(_this__u8e3s4, $completion);
  }
  return Unit_instance;
}
...
function writer$slambda_0($block, $channel) {
  ...
  var l = ($this$launch, $completion) => i.f2h($this$launch, $completion);
  l.$arity = 1;
  return l;
}
...
function transferFromDelegate($this) {
  updateConsumed($this);
  var appended = $this.i2h_1.n2c($this.h2h_1.z2e());
  $this.j2h_1 = add($this.j2h_1, appended);
}
function updateConsumed($this) {
  $this.k2h_1 = add($this.k2h_1, subtract($this.j2h_1, $this.i2h_1.g2()));
  $this.j2h_1 = $this.i2h_1.g2();
}
...
function LineEndingMode__toString_impl_j4h76r($this) {
  var tmp;
  if ($this === Companion_getInstance_2().m2h_1) {
    tmp = 'CR';
  } else if ($this === Companion_getInstance_2().n2h_1) {
    tmp = 'LF';
  } else if ($this === Companion_getInstance_2().o2h_1) {
    tmp = 'CRLF';
  } else {
    // Inline function 'kotlin.collections.filter' call
    var tmp0 = Companion_getInstance_2().q2h_1;
    // Inline function 'kotlin.collections.filterTo' call
    var destination = ArrayList.p2();
    var _iterator__ex2g4s = tmp0.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var it = element.r2h_1;
...
function writeFully_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  _this__u8e3s4.e2c(buffer, offset, offset + length | 0);
}
function build(_this__u8e3s4) {
  return _this__u8e3s4.u2a();
}
function get_size(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.u2a().g2());
}
...
function ByteReadPacket(array, offset, length) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = new Buffer();
  this_0.e2c(array, offset, offset + length | 0);
  return this_0;
}
function get_remaining(_this__u8e3s4) {
  _init_properties_ByteReadPacket_kt__28475y();
  return _this__u8e3s4.u2a().g2();
}
function discard_0(_this__u8e3s4, count) {
  count = count === VOID ? 9223372036854775807n : count;
  _init_properties_ByteReadPacket_kt__28475y();
  _this__u8e3s4.x2a(count);
  // Inline function 'kotlin.comparisons.minOf' call
  var b = get_remaining(_this__u8e3s4);
  var countToDiscard = count <= b ? count : b;
  _this__u8e3s4.u2a().s2b(countToDiscard);
  return countToDiscard;
}
function takeWhile(_this__u8e3s4, block) {
  _init_properties_ByteReadPacket_kt__28475y();
  while (!_this__u8e3s4.v2a() && block(_this__u8e3s4.u2a())) {
  }
}
...
function readAvailable_0(_this__u8e3s4, buffer, offset, length) {
  offset = offset === VOID ? 0 : offset;
  length = length === VOID ? buffer.length - offset | 0 : length;
  var result = _this__u8e3s4.t2b(buffer, offset, offset + length | 0);
  return result === -1 ? 0 : result;
}
function toByteArray_0(_this__u8e3s4, charset) {
  charset = charset === VOID ? Charsets_getInstance().y2h_1 : charset;
  if (charset.equals(Charsets_getInstance().y2h_1))
    return encodeToByteArray(_this__u8e3s4, VOID, VOID, true);
  return encodeToByteArray_0(charset.b2i(), _this__u8e3s4, 0, _this__u8e3s4.length);
}
function readText_0(_this__u8e3s4, charset, max) {
  ...
  if (charset.equals(Charsets_getInstance().y2h_1)) {
    if (max === 2147483647)
      return readString_0(_this__u8e3s4);
    var tmp0 = _this__u8e3s4.u2a().g2();
    // Inline function 'kotlin.math.min' call
    var b = fromInt(max);
    var count = tmp0 <= b ? tmp0 : b;
    return readString(_this__u8e3s4, count);
  }
  return decode(charset.c2i(), _this__u8e3s4, max);
}
function writeText(_this__u8e3s4, text, fromIndex, toIndex, charset) {
  fromIndex = fromIndex === VOID ? 0 : fromIndex;
  toIndex = toIndex === VOID ? charSequenceLength(text) : toIndex;
  charset = charset === VOID ? Charsets_getInstance().y2h_1 : charset;
  if (charset === Charsets_getInstance().y2h_1) {
    return writeString(_this__u8e3s4, toString_1(text), fromIndex, toIndex);
  }
  encodeToImpl(charset.b2i(), _this__u8e3s4, text, fromIndex, toIndex);
}
...
function get_name(_this__u8e3s4) {
  return _this__u8e3s4.a2i_1;
}
function isSupported(_this__u8e3s4, name) {
  return Companion_instance_4.q2i(name);
}
function forName(_this__u8e3s4, name) {
  return Companion_instance_4.p2i(name);
}
function decode_0(_this__u8e3s4, input, dst, max) {
  var decoder = Decoder(get_name(get_charset(_this__u8e3s4)), true);
  var tmp0 = input.u2a().g2();
  // Inline function 'kotlin.comparisons.minOf' call
  var b = fromInt(max);
  var count = tmp0 <= b ? tmp0 : b;
  ...
  try {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    tmp = decoder.t2i(array);
  } catch ($p) {
    var tmp_0;
    if ($p instanceof Error) {
      var cause = $p;
      var tmp0_elvis_lhs = cause.message;
      throw MalformedInputException.x2h('Failed to decode bytes: ' + (tmp0_elvis_lhs == null ? 'no cause provided' : tmp0_elvis_lhs));
    } else {
      throw $p;
    }
  }
...
function encodeImpl(_this__u8e3s4, input, fromIndex, toIndex, dst) {
  ...
  if (get_charset_0(_this__u8e3s4).equals(Charsets_getInstance().z2h_1)) {
    return encodeISO88591(input, fromIndex, toIndex, dst);
  }
  // Inline function 'kotlin.require' call
  if (!(get_charset_0(_this__u8e3s4) === Charsets_getInstance().y2h_1)) {
...
function get_charset(_this__u8e3s4) {
  return _this__u8e3s4.r2i_1;
}
function get_charset_0(_this__u8e3s4) {
  return _this__u8e3s4.s2i_1;
}
...
function ioDispatcher() {
  return Dispatchers_getInstance().f13_1;
}
function encodeISO88591(input, fromIndex, toIndex, dst) {
  ...
  if (inductionVariable < toIndex)
    do {
      ...
      dst.o2c(toByte(character));
    }
     while (inductionVariable < toIndex);
  return toIndex - fromIndex | 0;
}
function failedToMapError(ch) {
  throw MalformedInputException.x2h('The character with unicode point ' + ch + " couldn't be mapped to ISO-8859-1 character");
}
...
protoOf(Read).h2e = resume;
protoOf(Read).i2e = resume_0;
initMetadataForClass(Read, 'Read', VOID, VOID, [Task]);
protoOf(Write).h2e = resume;
protoOf(Write).i2e = resume_0;
...
protoOf(ByteChannel).y2f = awaitContent$default;
...
protoOf(ByteReadChannel$Companion$Empty$1).y2f = awaitContent$default;
...
protoOf(CountedByteReadChannel).y2f = awaitContent$default;
initMetadataForClass(CountedByteReadChannel, 'CountedByteReadChannel', VOID, VOID, [ByteReadChannel], [1]);
initMetadataForClass(ClosedByteChannelException, 'ClosedByteChannelException', ClosedByteChannelException.q2f);
initMetadataForClass(ClosedReadChannelException, 'ClosedReadChannelException', ClosedReadChannelException.e2f);
initMetadataForClass(ClosedWriteChannelException, 'ClosedWriteChannelException', ClosedWriteChannelException.k2f);
initMetadataForClass(LineEnding, 'LineEnding');
initMetadataForCompanion(Companion_2);
initMetadataForClass(LineEndingMode, 'LineEndingMode');
protoOf(SourceByteReadChannel).y2f = awaitContent$default;

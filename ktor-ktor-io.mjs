...
class CharsetEncoderImpl extends CharsetEncoder {
  ...
  toString() {
    return 'CharsetEncoderImpl(charset=' + this.n2i_1.toString() + ')';
  }
  hashCode() {
    return this.n2i_1.hashCode();
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof CharsetEncoderImpl))
      return false;
    if (!this.n2i_1.equals(other.n2i_1))
      return false;
    return true;
  }
}
class CharsetDecoderImpl extends CharsetDecoder {
  ...
  toString() {
    return 'CharsetDecoderImpl(charset=' + this.p2i_1.toString() + ')';
  }
  hashCode() {
  ...
  equals(other) {
    ...
    if (!(other instanceof CharsetDecoderImpl))
      return false;
    if (!this.p2i_1.equals(other.p2i_1))
      return false;
    return true;
  }
}
class toKtor$1 {
  constructor($this_toKtor) {
    this.q2i_1 = $this_toKtor;
  }
  k2i(buffer) {
    return this.q2i_1.decode(buffer);
  }
}
...
function isSupported(_this__u8e3s4, name) {
  return Companion_instance_4.h2i(name);
}
